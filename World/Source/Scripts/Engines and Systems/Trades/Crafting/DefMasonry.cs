...
namespace Server.Engines.Craft
{
    public class DefMasonry : CraftSystem
    {
        ...
        {
            get { return "Crafting: Stone Working"; }
        }
        ...
        {
            CraftSystem.CraftSound(from, 0x65A, m_Tools);
        }
        ...
        public override void InitCraftList()
        {
            ...
            AddSubRes(typeof(VeriteGranite), 1044029, 94.0, 1044514, 1044527);
            AddSubRes(typeof(ValoriteGranite), 1044030, 95.0, 1044514, 1044527);
            AddSubRes(typeof(NepturiteGranite), 1036173, 96.0, 1044514, 1044527);
            AddSubRes(typeof(ObsidianGranite), 1036162, 97.0, 1044514, 1044527);
            AddSubRes(typeof(SteelGranite), 1036144, 98.0, 1044514, 1044527);
            AddSubRes(typeof(BrassGranite), 1036152, 99.0, 1044514, 1044527);
