...
namespace Server.Items
{
    ...
    public class TrophyBase : Item
    {
        ...
        {
            from.SendGump(new SpeechGump(from, "The Trophies of War", SpeechFunctions.SpeechText(from, from, "Trophy")));
        }
                ...
                else
                {
                    ...
                    if (obj != null)
                    {
                        ...
                        else
                        {
                            ...
                            else if ((typeof(DrakkhenRed) == c.Owner.GetType()) || (typeof(Dragoon) == c.Owner.GetType() && i.Amount == 604))
                            {
                                trophyID = 0x65AD;
                                trophyColor = 0xB01;
                            }
                            else if ((typeof(DrakkhenBlack) == c.Owner.GetType()) || (typeof(Dragoon) == c.Owner.GetType()))
                            {
                                trophyID = 0x6553;
                                trophyColor = 0;
                            }
                            ...
                            (typeof(DragonGolem) == c.Owner.GetType())) { trophyID = 0x270D; }
                            ...
                            else if ((typeof(SabretoothBearRiding) == c.Owner.GetType()) ||
                            ...
                            else if ((typeof(ElderBlackBearRiding) == c.Owner.GetType()) ||
                            ...
                            else if (typeof(PredatorHellCatRiding) == c.Owner.GetType())
                            {
                                trophyID = 0x3389;
                            }
                            else if (typeof(LionRiding) == c.Owner.GetType())
                            {
                                trophyID = 0x654D;
                                trophyColor = 0;
                            }
                            ...
                            else if ((typeof(SnowLion) == c.Owner.GetType()) ||
                            (typeof(ManticoreRiding) == c.Owner.GetType()) ||
                            ...
                            else if ((typeof(AntaurKing) == c.Owner.GetType()) ||
                            ...
                            else if (typeof(Nightmare) == c.Owner.GetType() || typeof(AncientNightmareRiding) == c.Owner.GetType() || typeof(Placeron) == c.Owner.GetType()) { trophyID = 0x33AD; }
                            else if ((typeof(Wyverns) == c.Owner.GetType()) ||
