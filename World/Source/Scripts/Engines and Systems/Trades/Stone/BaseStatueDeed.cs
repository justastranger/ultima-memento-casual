...
namespace Server.Items
{
    public class BaseStatueAddon : BaseAddon
    {
        ...
        public bool StatueBuilt;
        public Mobile StatueBuiltBy;
        public CraftResource StatueResource;
        ...
        [CommandProperty(AccessLevel.Owner)]
        public bool Statue_Built { get { return StatueBuilt; } set { StatueBuilt = value; InvalidateProperties(); } }

        [CommandProperty(AccessLevel.Owner)]
        public Mobile Statue_BuiltBy { get { return StatueBuiltBy; } set { StatueBuiltBy = value; InvalidateProperties(); } }

        [CommandProperty(AccessLevel.Owner)]
        public CraftResource Statue_Resource { get { return StatueResource; } set { StatueResource = value; InvalidateProperties(); } }

        public override BaseAddonDeed Deed
        {
            get
            {
                return new BaseStatueDeed(StatueID, StatueColor, StatueMaterial, StatueMaker, StatueName, StatueBuilt, StatueBuiltBy, StatueResource);
            }
        }

        [Constructable]
        public BaseStatueAddon() : this(1, 0xB8E, "Granite", "", "statue", false, null, CraftResource.None)
        {
        }

        [Constructable]
        public BaseStatueAddon(int vStatueID, int vStatueColor, string vStatueMaterial, string vStatueMaker, string vStatueName, bool vStatueBuilt, Mobile vStatueBuiltBy, CraftResource vStatueResource)
        {
            ...
            StatueBuilt = vStatueBuilt;
            StatueBuiltBy = vStatueBuiltBy;
            StatueResource = vStatueResource;

            Built = vStatueBuilt;
            BuiltBy = vStatueBuiltBy;
            Resource = vStatueResource;
            Catalog = Catalogs.Stone;
        }
        ...
        public override void Serialize(GenericWriter writer)
        {
            ...
            writer.Write(StatueBuilt);
            writer.Write(StatueBuiltBy);
            writer.WriteEncodedInt((int)StatueResource);
        ...
        public override void Deserialize(GenericReader reader)
        {
            ...
            switch (version)
            {
                case 1:
                    {
                        StatueBuiltBy = reader.ReadMobile();
                        StatueBuilt = reader.ReadBool();
                        StatueResource = (CraftResource)reader.ReadEncodedInt();
                        goto case 0;
                    }
                case 0:
                    {
    ...
    public class BaseStatueDeed : BaseAddonDeed
    {
        ...
        public override BaseAddon Addon
        {
            get
            {
                return new BaseStatueAddon(StatueID, StatueColor, StatueMaterial, StatueMaker, StatueName, StatueBuilt, StatueBuiltBy, StatueResource);
            }
        }

        [Constructable]
        public BaseStatueDeed() : this(0, 0xB8E, "Granite", "", "statue", false, null, CraftResource.None)
        {
        }

        [Constructable]
        public BaseStatueDeed(int vStatueID, int vStatueColor, string vStatueMaterial, string vStatueMaker, string vStatueName, bool vStatueBuilt, Mobile vStatueBuiltBy, CraftResource vStatueResource)
        {
            Name = "statue";
            ItemID = 0x32F0;
            Weight = 10;
        ...
        public override void AddNameProperties(ObjectPropertyList list)
        {
            ...
            list.Add(1070722, "Made From " + CraftResources.GetPrefix(StatueResource) + StatueMaterial + "");
    ...
    class Statues
    {
        public static void SetStatue(BaseStatueDeed statue, int StatueID, int StatueColor, string StatueMaterial, string StatueMaker, string StatueName, bool StatueBuilt, Mobile StatueBuiltBy, CraftResource StatueResource)
        {
            ...
            statue.StatueBuiltBy = StatueBuiltBy;
            statue.StatueBuilt = StatueBuilt;
            statue.StatueResource = StatueResource;
            statue.Hue = StatueColor;
            statue.Name = StatueName;
            statue.Weight = 10;

            statue.Built = StatueBuilt;
            statue.BuiltBy = StatueBuiltBy;
            statue.Resource = StatueResource;
            statue.Catalog = Catalogs.Stone;
        }
