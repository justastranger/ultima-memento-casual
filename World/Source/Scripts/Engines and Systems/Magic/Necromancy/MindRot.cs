    ...
    public class MindRotSpell : NecromancerSpell
    {
        ...
        public void Target(Mobile m)
        {
            ...
            else if (CheckHSequence(m))
            {
				 ...
				 * for a duration based off a comparison between the Caster's Spiritualism skill and the Target's Magic Resistance skill.
				 * The effect lasts for ((Spiritualism skill level - target's Resist Magic skill level) / 50 ) + 20 seconds.
				 */
