                ...
                ResistanceMod[] mods = new ResistanceMod[4]
                    {
                        ...
                        new ResistanceMod( ResistanceType.Cold, +MyServerSettings.PlayerLevelMod( 10, Caster ) ),
                        new ResistanceMod( ResistanceType.Physical, +MyServerSettings.PlayerLevelMod( 10, Caster ) )
                    };
