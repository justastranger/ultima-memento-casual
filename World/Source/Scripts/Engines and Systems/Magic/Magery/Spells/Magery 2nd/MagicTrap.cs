    ...
    public class MagicTrapSpell : MagerySpell
    {
        ...
        public void Target(TrapableContainer item)
        {
            ...
            else if (CheckSequence())
            {
                ...
                item.TrapPower = (int)(Spell.ItemSkillValue(Caster, SkillName.Magery, false));
        ...
        public void MTarget(IPoint3D p)
        {
            ...
            else if (SpellHelper.CheckTown(p, Caster) && CheckSequence())
            {
                ...
                else
                {
                    ...
                    int TrapPower = (int)(Spell.ItemSkillValue(Caster, SkillName.Magery, false) / 2);
                    SpellTrap mtrap = new SpellTrap(Caster, TrapPower);
                    mtrap.Map = Caster.Map;
                    mtrap.Location = loc;

                    Effects.SendLocationParticles(EffectItem.Create(loc, Caster.Map, EffectItem.DefaultDuration), 0x376A, 9, 10, PlayerSettings.GetMySpellHue(true, Caster, 0), 0, 9502, 0);
