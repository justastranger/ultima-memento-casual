    ...
    public class FireFieldSpell : MagerySpell
    {
        ...
        public void Target(IPoint3D p)
        {
            ...
            else if (SpellHelper.CheckTown(p, Caster) && CheckSequence())
            {
                ...
                duration = TimeSpan.FromSeconds(((15 + (Spell.ItemSkillValue(Caster, SkillName.Magery, true) / 5)) / 4) + nBenefit);
            ...
            private class InternalTimer : Timer
            {
                ...
                protected override void OnTick()
                {
                    ...
                    if (!m_Item.Visible)
                    {
                        ...
                        {
                            m_Item.ProcessDelta();
                            Effects.SendLocationParticles(EffectItem.Create(m_Item.Location, m_Item.Map, EffectItem.DefaultDuration), 0x376A, 9, 10, PlayerSettings.GetMySpellHue(true, m_Item.m_Caster, 0), 0, 5029, 0);
                        }
                    }
