    ...
    public class RecallSpell : MagerySpell
    {
        ...
        public void Effect(Point3D loc, Map map, bool checkMulti)
        {
            ...
            else if (CheckSequence())
            {
                ...
                Effects.SendLocationParticles(EffectItem.Create(Caster.Location, Caster.Map, EffectItem.DefaultDuration), 0x376A, 9, 32, Server.Misc.PlayerSettings.GetMySpellHue(true, Caster, 0), 0, 5024, 0);
