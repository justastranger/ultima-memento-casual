    ...
    public class EnergyFieldSpell : MagerySpell
    {
        ...
        public void Target(IPoint3D p)
        {
            ...
            else if (SpellHelper.CheckTown(p, Caster) && CheckSequence())
            {
                ...
                TimeSpan duration = TimeSpan.FromSeconds((15 + (Spell.ItemSkillValue(Caster, SkillName.Magery, true) / 5)) / 7);
                ...
                for (int i = -2; i <= 2; ++i)
                {
                    ...
                    Effects.SendLocationParticles(EffectItem.Create(loc, Caster.Map, EffectItem.DefaultDuration), 0x376A, 9, 10, PlayerSettings.GetMySpellHue(true, Caster, 0), 0, 5051, 0);
                }
            }
