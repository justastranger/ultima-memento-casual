    ...
    public class PoisonFieldSpell : MagerySpell
    {
        ...
        public void Target(IPoint3D p)
        {
            ...
            else if (SpellHelper.CheckTown(p, Caster) && CheckSequence())
            {
                ...
                TimeSpan duration = TimeSpan.FromSeconds(3 + (Spell.ItemSkillValue(Caster, SkillName.Magery, true) / 25) + nBenefit);
        ...
        public class InternalItem : Item
        {
            ...
            public void ApplyPoisonTo(Mobile m)
            {
                ...
                int total = (int)(Spell.ItemSkillValue(m_Caster, SkillName.Magery, false) + m_Caster.Skills[SkillName.Poisoning].Value);
            ...
            private class InternalTimer : Timer
            {
                ...
                protected override void OnTick()
                {
                    ...
                    if (!m_Item.Visible)
                    {
                        ...
                        {
                            m_Item.ProcessDelta();
                            Effects.SendLocationParticles(EffectItem.Create(m_Item.Location, m_Item.Map, EffectItem.DefaultDuration), 0x376A, 9, 10, PlayerSettings.GetMySpellHue(true, m_Item.m_Caster, 0), 0, 5040, 0);
                        }
                    }
