    ...
    public class DispelFieldSpell : MagerySpell
    {
        ...
        public void Target(Item item)
        {
            ...
            else if (CheckSequence())
            {
                ...
                Effects.SendLocationParticles(EffectItem.Create(item.Location, item.Map, EffectItem.DefaultDuration), 0x376A, 9, 20, Server.Misc.PlayerSettings.GetMySpellHue(true, Caster, 0), 0, 5042, 0);
