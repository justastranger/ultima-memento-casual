    ...
    public class HealSpell : MagerySpell
    {
        ...
        public void Target(Mobile m)
        {
            ...
            else if (CheckBSequence(m))
            {
                ...
                toHeal = (int)(Spell.ItemSkillValue(Caster, SkillName.Magery, true) / 120);
                ...
                m.FixedParticles(0x376A, 9, 32, 5005, PlayerSettings.GetMySpellHue(true, Caster, 0), 0, EffectLayer.Waist);
                m.PlaySound(0x1F2);
            }
