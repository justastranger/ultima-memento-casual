...
namespace Server.Mobiles
{
    ...
    public class ElementalSpiritAir : BaseCreature
    {
        ...
        [Constructable]
        public ElementalSpiritAir() : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            SetStr(200);
            SetDex(200);
            SetInt(100);
        ...
        public ElementalSpiritAir(Serial serial) : base(serial)
        {
        }
