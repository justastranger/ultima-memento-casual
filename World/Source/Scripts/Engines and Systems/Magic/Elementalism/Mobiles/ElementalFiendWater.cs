...
namespace Server.Mobiles
{
    ...
    public class ElementalFiendWater : BaseCreature
    {
        ...
        [Constructable]
        public ElementalFiendWater() : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.3, 0.6)
        {
            Name = "a watery fiend";
            Body = 51;
            BaseSoundID = 456;
        ...
        public ElementalFiendWater(Serial serial) : base(serial)
        {
        }
