...
namespace Server.Mobiles
{
    ...
    public class ElementalLordAir : BaseCreature
    {
        ...
        [Constructable]
        public ElementalLordAir() : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public ElementalLordAir(Serial serial) : base(serial)
        {
        }
