...
namespace Server.Mobiles
{
    ...
    public class ElementalSpiritEarth : BaseCreature
    {
        ...
        [Constructable]
        public ElementalSpiritEarth() : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            SetStr(200);
            SetDex(200);
            SetInt(100);
        ...
        public ElementalSpiritEarth(Serial serial) : base(serial)
        {
        }
