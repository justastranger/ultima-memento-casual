...
namespace Server.Mobiles
{
    ...
    public class ElementalSpiritFire : BaseCreature
    {
        ...
        [Constructable]
        public ElementalSpiritFire() : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            SetStr(200);
            SetDex(200);
            SetInt(100);
        ...
        public ElementalSpiritFire(Serial serial) : base(serial)
        {
        }
