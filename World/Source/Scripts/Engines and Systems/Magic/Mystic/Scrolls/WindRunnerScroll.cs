...
{
    public class WindRunnerScroll : SpellScroll
    {
        public override string DefaultDescription { get { return MysticSpell.SpellDescription(259); } }
        ...
        [Constructable]
        public WindRunnerScroll() : base(259, 0x2DD)
        {
            Name = "wind runner";
        }

        public WindRunnerScroll(Serial serial) : base(serial)
        {
        }
