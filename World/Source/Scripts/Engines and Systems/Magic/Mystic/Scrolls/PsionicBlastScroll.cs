...
{
    public class PsionicBlastScroll : SpellScroll
    {
        public override string DefaultDescription { get { return MysticSpell.SpellDescription(255); } }
        ...
        [Constructable]
        public PsionicBlastScroll() : base(255, 0x2DD)
        {
            Name = "psionic blast";
        }

        public PsionicBlastScroll(Serial serial) : base(serial)
        {
        }
