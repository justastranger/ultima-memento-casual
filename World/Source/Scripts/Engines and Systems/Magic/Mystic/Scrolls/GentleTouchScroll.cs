...
{
    public class GentleTouchScroll : SpellScroll
    {
        public override string DefaultDescription { get { return MysticSpell.SpellDescription(253); } }
        ...
        [Constructable]
        public GentleTouchScroll() : base(253, 0x2DD)
        {
            Name = "gentle touch";
        }

        public GentleTouchScroll(Serial serial) : base(serial)
        {
        }
