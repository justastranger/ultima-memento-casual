...
{
    public class LeapScroll : SpellScroll
    {
        public override string DefaultDescription { get { return MysticSpell.SpellDescription(254); } }
        ...
        [Constructable]
        public LeapScroll() : base(254, 0x2DD)
        {
            Name = "leap";
        }

        public LeapScroll(Serial serial) : base(serial)
        {
        }
