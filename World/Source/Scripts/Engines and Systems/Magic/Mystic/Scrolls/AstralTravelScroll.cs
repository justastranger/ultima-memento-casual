...
{
    public class AstralTravelScroll : SpellScroll
    {
        public override string DefaultDescription { get { return MysticSpell.SpellDescription(251); } }
        ...
        [Constructable]
        public AstralTravelScroll() : base(251, 0x2DD)
        {
            Name = "astral travel";
        }

        public AstralTravelScroll(Serial serial) : base(serial)
        {
        }
