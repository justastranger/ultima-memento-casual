...
{
    public class PurityOfBodyScroll : SpellScroll
    {
        public override string DefaultDescription { get { return MysticSpell.SpellDescription(257); } }
        ...
        [Constructable]
        public PurityOfBodyScroll() : base(257, 0x2DD)
        {
            Name = "purity of body";
        }

        public PurityOfBodyScroll(Serial serial) : base(serial)
        {
        }
