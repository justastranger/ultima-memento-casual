...
{
    public class ResearchSummonWeedElemental : ResearchSpell
    {
        public override int spellIndex { get { return 13; } }
        public int CirclePower = 7;
        public static int spellID = 13;
        ...
        private static SpellInfo m_Info = new SpellInfo(
                ...
                269,
                9050,
                Reagent.RedLotus, Reagent.Nightshade
            );

        public ResearchSummonWeedElemental(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
        ...
        public override void OnCast()
        {
            if (CheckSequence())
            {
                ...
                BaseCreature m_Creature = new WeedElemental();
