...
{
    public class ResearchSummonMudElemental : ResearchSpell
    {
        public override int spellIndex { get { return 29; } }
        public int CirclePower = 7;
        public static int spellID = 29;
        ...
        private static SpellInfo m_Info = new SpellInfo(
                ...
                269,
                9050,
                Reagent.PigIron, Reagent.MandrakeRoot
            );

        public ResearchSummonMudElemental(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
        ...
        public override void OnCast()
        {
            if (CheckSequence())
            {
                ...
                BaseCreature m_Creature = new MudElemental();
