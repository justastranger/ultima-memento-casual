...
{
    public class ResearchSummonElectricalElemental : ResearchSpell
    {
        public override int spellIndex { get { return 5; } }
        public int CirclePower = 7;
        public static int spellID = 5;
        ...
        private static SpellInfo m_Info = new SpellInfo(
                ...
                269,
                9050,
                Reagent.SilverWidow, Reagent.SulfurousAsh
            );
        ...
        public override void OnCast()
        {
            if (CheckSequence())
            {
                ...
                BaseCreature m_Creature = new ElectricalElemental();
