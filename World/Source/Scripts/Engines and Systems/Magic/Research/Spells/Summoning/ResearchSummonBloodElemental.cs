...
{
    public class ResearchSummonBloodElemental : ResearchSpell
    {
        public override int spellIndex { get { return 61; } }
        public int CirclePower = 8;
        public static int spellID = 61;
        ...
        private static SpellInfo m_Info = new SpellInfo(
                ...
                269,
                9050,
                Reagent.BlackPearl, Reagent.Bloodmoss, Reagent.DragonBlood, Reagent.DaemonBlood
            );

        public ResearchSummonBloodElemental(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
