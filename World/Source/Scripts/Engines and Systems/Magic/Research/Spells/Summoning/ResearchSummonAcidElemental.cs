...
{
    public class ResearchSummonAcidElemental : ResearchSpell
    {
        public override int spellIndex { get { return 45; } }
        public int CirclePower = 8;
        public static int spellID = 45;
        ...
        private static SpellInfo m_Info = new SpellInfo(
                ...
                269,
                9050,
                Reagent.SwampBerries, Reagent.NoxCrystal, Reagent.BeetleShell, Reagent.EyeOfToad
            );

        public ResearchSummonAcidElemental(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
        ...
        public override void OnCast()
        {
            if (CheckSequence())
            {
                ...
                BaseCreature m_Creature = new ToxicElemental();
