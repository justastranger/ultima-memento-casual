...
namespace Server.Misc
{
    ...
    class Research
    {
        ...
        public static string SpellInformation(int index, int slice) ///////////////////////////////////////////////////////////////////////////////
        {
            ...
            if (index == 1)
            {
                circle = "1"; name = "Conjure"; school = "Conjuration"; words = "kal xen"; reagents = "Moon Crystal, Fairy Egg"; mana = "10"; skill = "15";
            ...
            {
                circle = "1"; name = "Death Speak"; school = "Death"; words = "kal wis corp"; reagents = "Grave Dust, Pixie Skull"; mana = "5"; skill = "10";
            ...
            {
                circle = "1"; name = "Sneak"; school = "Enchanting"; words = "por ex tym"; reagents = "Fairy Egg, Pixie Skull"; mana = "10"; skill = "10";
            ...
            {
                circle = "1"; name = "Create Fire"; school = "Sorcery"; words = "in flam ylem"; reagents = "Brimstone, Mandrake Root, Ginseng"; mana = "5"; skill = "15";
            ...
            {
                circle = "1"; name = "Electrical Elemental"; school = "Summoning"; words = "uus grav"; reagents = "Silver Widow, Sulfurous Ash"; mana = "40"; skill = "70";
                init = "655"; description = "Summons an electrial elemental that is controlled by the caster for 8-25 minutes.";
            }
            else if (index == 6)
            {
                circle = "1"; name = "Confusion Blast"; school = "Thaumaturgy"; words = "in quas wis"; reagents = "Mandrake Root, Pixie Skull, Fairy Egg"; mana = "15"; skill = "40";
            ...
            {
                circle = "1"; name = "See Truth"; school = "Theurgy"; words = "an quas lor"; reagents = "Grave Dust, Sea Salt, Fairy Egg"; mana = "60"; skill = "20";
            ...
            {
                circle = "1"; name = "Icicle"; school = "Wizardry"; words = "ex des bet"; reagents = "Moon Crystal, Pig Iron"; mana = "10"; skill = "15";
                init = "632"; description = "Throws a magical icicle at your enemies that can cause up to 80 points of cold damage.";
            }

            else if (index == 9)
            {
                circle = "2"; name = "Extinguish"; school = "Conjuration"; words = "an flam"; reagents = "Nightshade, Sea Salt, Black Pearl"; mana = "20"; skill = "35";
            ...
            {
                circle = "2"; name = "Rock Flesh"; school = "Death"; words = "rel sanct ylem"; reagents = "Moon Crystal, Garlic, Pig Iron, Black Pearl"; mana = "10"; skill = "15";
            ...
            {
                circle = "2"; name = "Mass Might"; school = "Enchanting"; words = "in vas por"; reagents = "Fairy Egg, Butterfly Wings"; mana = "99"; skill = "66";
            ...
            {
                circle = "2"; name = "Endure Cold"; school = "Sorcery"; words = "vas sanct flam"; reagents = "Spiders Silk, Moon Crystal"; mana = "15"; skill = "20";
            ...
            {
                circle = "2"; name = "Weed Elemental"; school = "Summoning"; words = "uus kal"; reagents = "Red Lotus, Nightshade"; mana = "40"; skill = "70";
                init = "660"; description = "Summons a weed elemental that is controlled by the caster for 8-25 minutes.";
            }
            else if (index == 14)
            {
                circle = "2"; name = "Spawn Creatures"; school = "Thaumaturgy"; words = "vas kal xen"; reagents = "Ginseng, Grave Dust, Pixie Skull"; mana = "20"; skill = "45";
                init = "652"; description = "Summons random creatures that are controlled by the caster for 8-25 minutes.";
            }
            else if (index == 15)
            {
                circle = "2"; name = "Healing Touch"; school = "Theurgy"; words = "in mani"; reagents = "Garlic, Ginseng, Fairy Egg, Pixie Skull"; mana = "15"; skill = "30";
                init = "631"; description = "Heals the one touched, restoring 12-125 hit points. You need to be close to your target, however.";
            }
            else if (index == 16)
            {
                circle = "2"; name = "Snow Ball"; school = "Wizardry"; words = "ex des in"; reagents = "Black Pearl, Moon Crystal"; mana = "10"; skill = "10";
                init = "649"; description = "Throws a magical snow ball toward your enemy, which can cause 2-80 points of cold damage.";
            }

            else if (index == 17)
            {
                circle = "3"; name = "Clone"; school = "Conjuration"; words = "in quas xen"; reagents = "Gargoyle Ear, Fairy Egg"; mana = "25"; skill = "45";
            ...
            {
                circle = "3"; name = "Grant Peace"; school = "Death"; words = "in vas corp"; reagents = "Pixie Skull, Grave Dust"; mana = "35"; skill = "75";
            ...
            {
                circle = "3"; name = "Sleep"; school = "Enchanting"; words = "in zu tym"; reagents = "Fairy Egg, Mandrake Root, Sea Salt"; mana = "15"; skill = "40";
            ...
            {
                circle = "3"; name = "Endure Heat"; school = "Sorcery"; words = "sanct flam"; reagents = "Swamp Berries, Gargoyle Ear"; mana = "15"; skill = "20";
            ...
            {
                circle = "3"; name = "Ice Elemental"; school = "Summoning"; words = "uus ex des"; reagents = "Sea Salt, Moon Crystal"; mana = "40"; skill = "70";
                init = "657"; description = "Summons an ice elemental that is controlled by the caster for 8-25 minutes.";
            }
            else if (index == 22)
            {
                circle = "3"; name = "Ethereal Travel"; school = "Thaumaturgy"; words = "ort grav por"; reagents = "Black Pearl, Gargoyle Ear, Red Lotus"; mana = "20"; skill = "35";
            ...
            {
                circle = "3"; name = "Wizard Eye"; school = "Theurgy"; words = "por ort wis"; reagents = "Eye of Toad, Silver Widow, Gargoyle Ear, Black Pearl"; mana = "30"; skill = "50";
                init = "663"; description = "This spell allows the caster to identify items that have origins that are unknown to others.";
            }
            else if (index == 24)
            {
                circle = "3"; name = "Frost Field"; school = "Wizardry"; words = "in ex des"; reagents = "Moon Crystal, Eye of Toad, Spiders Silk"; mana = "15"; skill = "30";
                init = "627"; description = "Creates a wall of frost that can cause 2-16 points of cold damage per second to anyone within it.";
            }

            else if (index == 25)
            {
                circle = "4"; name = "Create Gold"; school = "Conjuration"; words = "rel ylem"; much = "true"; reagents = "Unicorn Horn, Sea Salt, Ginseng, Golden Serpent Venom"; mana = "35"; skill = "55";
            ...
            {
                circle = "4"; name = "Animate Bones"; school = "Death"; words = "kal corp xen"; reagents = "Bat Wing, Grave Dust, Pixie Skull"; mana = "40"; skill = "70";
            ...
            {
                circle = "4"; name = "Cause Fear"; school = "Enchanting"; words = "quas wis tym"; reagents = "Bloodmoss, Daemon Blood, Red Lotus"; mana = "35"; skill = "45";
            ...
            {
                circle = "4"; name = "Ignite"; school = "Sorcery"; words = "in flam"; reagents = "Brimstone, Sulfurous Ash, Black Pearl"; mana = "30"; skill = "40";
            ...
            {
                circle = "4"; name = "Mud Elemental"; school = "Summoning"; words = "uus des ylem"; reagents = "Pig Iron, Mandrake Root"; mana = "40"; skill = "70";
                init = "658"; description = "Summons a mud elemental that is controlled by the caster for 8-25 minutes.";
            }
            else if (index == 30)
            {
                circle = "4"; name = "Banish Daemon"; school = "Thaumaturgy"; words = "an flam corp xen"; reagents = "Gargoyle Ear, Demon Claw"; mana = "40"; skill = "80";
            ...
            {
                circle = "4"; name = "Fade from Sight"; school = "Theurgy"; words = "quas an lor"; reagents = "Red Lotus, Nox Crystal"; mana = "15"; skill = "50";
            ...
            {
                circle = "4"; name = "Gas Cloud"; school = "Wizardry"; words = "in hur grav"; reagents = "Nightshade, Silver Widow, Swamp Berries, Silver Serpent Venom"; mana = "25"; skill = "45";
            ...
            {
                circle = "5"; name = "Swarm"; school = "Conjuration"; words = "kal bet xen"; reagents = "Beetle Shell, Silver Widow, Fairy Egg"; mana = "15"; skill = "40";
                init = "661"; description = "Unleashes a swarm of insects at your enemies for 1-3 minutes.";
            }
            else if (index == 34)
            {
                circle = "5"; name = "Mask of Death"; school = "Death"; words = "quas corp"; reagents = "Lich Dust, Grave Dust, Pixie Skull"; mana = "70"; skill = "90";
            ...
            {
                circle = "5"; name = "Enchant"; school = "Enchanting"; words = "ort ylem tym"; reagents = "Pixie Skull, Fairy Egg, Dragon Tooth, Moon Crystal"; mana = "45"; skill = "75";
            ...
            {
                circle = "5"; name = "Flame Bolt"; school = "Sorcery"; words = "in ort flam"; reagents = "Brimstone, Sulfurous Ash"; mana = "15"; skill = "30";
                init = "626"; description = "Throws a magical bolt of flame at your enemies that can cause 12-100 points of fire damage.";
            }
            else if (index == 37)
            {
                circle = "5"; name = "Gem Elemental"; school = "Summoning"; words = "uus sanct"; reagents = "Moon Crystal, Pig Iron"; mana = "50"; skill = "80";
                init = "656"; description = "Summons a gem rock elemental that is controlled by the caster for 8-25 minutes.";
            }
            else if (index == 38)
            {
                circle = "5"; name = "Call Destruction"; school = "Thaumaturgy"; words = "kal vas grav por"; much = "true"; reagents = "Bat Wing, Black Pearl, Brimstone, Pig Iron"; mana = "25"; skill = "40";
            ...
            {
                circle = "5"; name = "Divination"; school = "Theurgy"; words = "in wis tym"; reagents = "Ginseng, Daemon Blood, Eye of Toad"; mana = "30"; skill = "50";
            ...
            {
                circle = "5"; name = "Frost Strike"; school = "Wizardry"; words = "ex des corp"; reagents = "Moon Crystal, Grave Dust"; mana = "40"; skill = "67";
                init = "628"; description = "Damages an enemy with a column of frost crystals that causes 35-125 points of cold damage.";
            }

            else if (index == 41)
            {
                circle = "6"; name = "Magic Steed"; school = "Conjuration"; words = "in xen tym"; reagents = "Bat Wing, Butterfly Wings"; mana = "30"; skill = "50";
                init = "635"; description = "Lures a horse to the caster's location where it can be ridden for 8-25 minutes.";
            }
            else if (index == 42)
            {
                circle = "6"; name = "Create Golem"; school = "Death"; words = "in ort ylem xen"; reagents = "Pixie Skull, Grave Dust, Daemon Blood"; mana = "40"; skill = "70";
            ...
            {
                circle = "6"; name = "Sleep Field"; school = "Enchanting"; words = "in zu grav tym"; reagents = "Fairy Egg, Mandrake Root, Sea Salt, Grave Dust"; mana = "30"; skill = "60";
            ...
            {
                circle = "6"; name = "Conflagration"; school = "Sorcery"; words = "kal vas flam corp xen"; reagents = "Sulfurous Ash, Brimstone, Gargoyle Ear"; mana = "20"; skill = "35";
                init = "608"; description = "Creates a huge inferno that can cause 2-16 points of fire damage per second to anyone within it.";
            }
            else if (index == 45)
            {
                circle = "6"; name = "Acid Elemental"; school = "Summoning"; words = "uus corp"; reagents = "Swamp Berries, Nox Crystal, Beetle Shell, Eye of Toad"; mana = "50"; skill = "82";
                init = "650"; description = "Summons an acid elemental that is controlled by the caster for 8-25 minutes.";
            }
            else if (index == 46)
            {
                circle = "6"; name = "Meteor Shower"; school = "Thaumaturgy"; words = "kal des flam ylem"; reagents = "Blood Moss, Brimstone, Mandrake Root, Black Pearl"; mana = "40"; skill = "70";
            ...
            {
                circle = "6"; name = "Intervention"; school = "Theurgy"; words = "in sanct an jux"; reagents = "Moon Crystal, Brimstone, Nightshade, Fairy Egg"; mana = "25"; skill = "50";
            ...
            {
                circle = "6"; name = "Hail Storm"; school = "Wizardry"; words = "vas ex des"; reagents = "Fairy Egg, Moon Crystal"; mana = "25"; skill = "55";
                init = "630"; description = "Creates a storm of ice around an enemy, causing 28-125 points of cold damage.";
            }

            else if (index == 49)
            {
                circle = "7"; name = "Aerial Servant"; school = "Conjuration"; words = "kal ort xen"; reagents = "Butterfly Wings, Gargoyle Ear, Pegasus Feather"; mana = "50"; skill = "80";
            ...
            {
                circle = "7"; name = "Open Ground"; school = "Death"; words = "des por ylem"; much = "true"; reagents = "Brimstone, Grave Dust, Pig Iron, Mandrake Root"; mana = "65"; skill = "85";
            ...
            {
                circle = "7"; name = "Charm"; school = "Enchanting"; words = "an xen ex"; reagents = "Enchanted Seaweed, Fairy Egg, Pixie Skull"; mana = "60"; skill = "82";
            ...
            {
                circle = "7"; name = "Explosion"; school = "Sorcery"; words = "vas ort flam"; reagents = "Fairy Egg, Brimstone, Sulfurous Ash"; mana = "30"; skill = "60";
            ...
            {
                circle = "7"; name = "Poison Elemental"; school = "Summoning"; words = "uus nox"; reagents = "Nightshade, Nox Crystal, Silver Serpent Venom, Silver Widow"; mana = "50"; skill = "86";
                init = "659"; description = "Summons a poison elemental that is controlled by the caster for 8-25 minutes.";
            }
            else if (index == 54)
            {
                circle = "7"; name = "Invoke Devil"; school = "Thaumaturgy"; words = "uus flam corp xen"; reagents = "Daemon Blood, Eye of Toad, Brimstone, Demon Claw"; mana = "60"; skill = "95";
            ...
            {
                circle = "7"; name = "Air Walk"; school = "Theurgy"; words = "vas hur por"; reagents = "Spiders Silk, Pixie Skull, Butterfly Wings"; mana = "55"; skill = "65";
            ...
            {
                circle = "7"; name = "Avalanche"; school = "Wizardry"; words = "ex vas des"; reagents = "Blood Moss, Spiders Silk, Mandrake Root, Moon Crystal"; mana = "40"; skill = "70";
            ...
            {
                circle = "8"; name = "Death Vortex"; school = "Conjuration"; words = "vas corp hur"; reagents = "Daemon Blood, Eye of Toad, Unicorn Horn"; mana = "60"; skill = "90";
            ...
            {
                circle = "8"; name = "Withstand Death"; school = "Death"; words = "vas an corp"; much = "true"; reagents = "Phoenix Feather, Demigod Blood, Enchanted Seaweed, Ghostly Dust"; mana = "70"; skill = "90";
            ...
            {
                circle = "8"; name = "Mass Sleep"; school = "Enchanting"; words = "vas zu tym"; reagents = "Fairy Egg, Mandrake Root, Enchanted Seaweed, Lich Dust"; mana = "50"; skill = "85";
            ...
            {
                circle = "8"; name = "Ring of Fire"; school = "Sorcery"; words = "in flam an por"; reagents = "Brimstone, Pig Iron, Daemon Blood"; mana = "55"; skill = "85";
            ...
            {
                circle = "8"; name = "Blood Elemental"; school = "Summoning"; words = "uus mani"; reagents = "Black Pearl, Bloodmoss, Dragon Blood, Daemon Blood"; mana = "50"; skill = "90";
                init = "651"; description = "Summons a blood elemental that is controlled by the caster for 8-25 minutes.";
            }
            else if (index == 62)
            {
                circle = "8"; name = "Armageddon"; school = "Thaumaturgy"; words = "in vas ort corp"; much = "true"; reagents = "Butterfly Wings, Black Pearl, Demigod Blood, Demon Claw"; mana = "80"; skill = "100";
            ...
            {
                circle = "8"; name = "Restoration"; school = "Theurgy"; words = "vas in mani"; reagents = "Butterfly Wings, Garlic, Enchanted Seaweed"; mana = "50"; skill = "80";
                init = "642"; description = "This spell can restore 12-125 points in health, stamina, and mana.";
            }
            else if (index == 64)
            {
                circle = "8"; name = "Mass Death"; school = "Wizardry"; words = "vas corp"; much = "true"; reagents = "Pixie Skull, Bat Wing, Dragon Tooth"; mana = "55"; skill = "90";
