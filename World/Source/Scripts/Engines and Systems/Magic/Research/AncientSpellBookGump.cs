...
namespace Server.Gumps
{
    public class AncientSpellbookGump : Gump
    {
        ...
        {
            if (page < 6) { return 1; }
            else if (page == 6) { return 17; }
            else if (page == 7) { return 33; }
            else if (page == 8) { return 49; }
            else if (page == 9) { return 2; }
            else if (page == 10) { return 18; }
            else if (page == 11) { return 34; }
            else if (page == 12) { return 50; }
            else if (page == 13) { return 3; }
            else if (page == 14) { return 19; }
            else if (page == 15) { return 35; }
            else if (page == 16) { return 51; }
            else if (page == 17) { return 4; }
            else if (page == 18) { return 20; }
            else if (page == 19) { return 36; }
            else if (page == 20) { return 52; }
            else if (page == 21) { return 5; }
            else if (page == 22) { return 21; }
            else if (page == 23) { return 37; }
            else if (page == 24) { return 53; }
            else if (page == 25) { return 6; }
            else if (page == 26) { return 22; }
            else if (page == 27) { return 38; }
            else if (page == 28) { return 54; }
            else if (page == 29) { return 7; }
            else if (page == 30) { return 23; }
            else if (page == 31) { return 39; }
            else if (page == 32) { return 55; }
