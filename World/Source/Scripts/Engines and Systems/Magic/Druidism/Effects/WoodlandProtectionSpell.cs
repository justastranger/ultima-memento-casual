    ...
    public class WoodlandProtectionSpell : HerbalistSpell
    {
        ...
        public override void OnCast()
        {
            ...
            else if (CheckSequence())
            {
                ...
                double span = (Caster.Skills[DamageSkill].Value / 2) * 60;
                ...
                string args = String.Format("{0}\t{1}\t{2}\t{3}\t{4}", MyResist, MyResist, MyResist, MyResist, MyResist);

                BuffInfo.AddBuff(Caster, new BuffInfo(BuffIcon.WoodlandProtection, 1063550, 1075818, args.ToString(), true));
            }
            FinishSequence();
        }
