...
namespace Server.Spells.Herbalist
{
    public class ShieldOfEarthSpell : HerbalistSpell
    {
        ...
        public void Target(IPoint3D p)
        {
            ...
            else if (SpellHelper.CheckTown(p, Caster) && CheckSequence())
            {
                ...
                for (int i = -2; i <= 2; ++i)
                {
                    ...
                    Item item = new InternalItem(loc, Caster.Map, Caster, (double)(Server.Items.BasePotion.EnhancePotions(Caster)));
        ...
        private class InternalItem : Item
        {
            ...
            public InternalItem(Point3D loc, Map map, Mobile caster, double enhance) : base(0x0C92)
            {
                Visible = false;
                Movable = false;
