...
{
    public class ForceGrip : JediSpell
    {
        public override int spellIndex { get { return 280; } }
        public int CirclePower = 1;
        public static int spellID = 280;
        ...
        public ForceGrip(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
