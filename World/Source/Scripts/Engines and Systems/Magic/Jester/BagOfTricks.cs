...
namespace Server.Items
{
    public class BagOfTricks : Item
    {
        ...
        public static string JokeInfo(int ability, string type)
        {
            ...
            if (ability == 20749 || ability == (20749 + 10))
            {
                if (type == "name") { str = "Can of Snakes"; }
                else if (type == "points") { str = "200"; }
            ...
            else if (ability == 20751 || ability == (20751 + 10))
            {
                if (type == "name") { str = "Clowns"; }
                else if (type == "points") { str = "50"; }
                else if (type == "mana") { str = "25"; }
                else
                {
            ...
            else if (ability == 20748 || ability == (20748 + 10))
            {
            ...
            else if (ability == 20750 || ability == (20750 + 10))
            {
                if (type == "name") { str = "Hilarity"; }
                else if (type == "points") { str = "40"; }
            ...
            else if (ability == 20747 || ability == (20747 + 10))
            {
                if (type == "name") { str = "Insult"; }
                else if (type == "points") { str = "60"; }
            ...
            else if (ability == 20754 || ability == (20754 + 10))
            {
                if (type == "name") { str = "Jump Around"; }
            ...
            else if (ability == 20746 || ability == (20746 + 10))
            {
                if (type == "name") { str = "Popping Balloon"; }
                else if (type == "points") { str = "100"; }
                else if (type == "mana") { str = "20"; }
                else
                {
            ...
            else if (ability == 20753 || ability == (20753 + 10))
            {
                if (type == "name") { str = "Rabbit in a Hat"; }
                else if (type == "points") { str = "150"; }
            ...
            else if (ability == 20755 || ability == (20755 + 10))
            {
                if (type == "name") { str = "Seltzer Bottle"; }
                else if (type == "points") { str = "50"; }
                else if (type == "mana") { str = "20"; }
                else
                {
            ...
            else if (ability == 20752 || ability == (20752 + 10))
            {
                if (type == "name") { str = "Surprise Gift"; }
                else if (type == "points") { str = "80"; }
                else if (type == "mana") { str = "20"; }
                else
                {
