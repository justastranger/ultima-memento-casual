    ...
    public class SpectreShadowSpell : UndeadSpell
    {
        ...
        public void Target(Mobile m)
        {
            ...
            else if (CheckBSequence(m))
            {
                ...
                TimeSpan duration = TimeSpan.FromSeconds(((6 * Caster.Skills.Forensics.Fixed) / 50) + 1);
                ...
                BuffInfo.AddBuff(Caster, new BuffInfo(BuffIcon.SpectralShadow, 1063498, duration, Caster));
