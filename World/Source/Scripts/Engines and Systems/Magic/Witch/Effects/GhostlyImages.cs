    ...
    public class GhostlyImagesSpell : UndeadSpell
    {
        ...
        public void Target(IPoint3D p)
        {
            ...
            else if (SpellHelper.CheckTown(p, Caster) && CheckSequence())
            {
                ...
                TimeSpan duration;
                duration = TimeSpan.FromSeconds((Server.Items.BasePotion.EnhancePotions(Caster) + Caster.Skills[DamageSkill].Value + Caster.Skills[CastSkill].Value) / 2);
                ...
                BuffInfo.AddBuff(Caster, new BuffInfo(BuffIcon.GhostlyImages, 1063500, duration, Caster));
            }
