        ...
        public void MakeVillain(QuestTome book)
        {
            ...
            if (enemy == 1)
            {
                switch (Utility.RandomMinMax(0, 3))
                {
                    ...
                    case 1:
                        book.VillainType = "ArchFiend"; book.VillainName = NameList.RandomName("demonic"); book.VillainBody = Utility.RandomList(191, 427); color = true;
                    ...
                    case 3:
                        book.VillainType = "Succubus"; book.VillainName = NameList.RandomName("goddess"); book.VillainBody = 174; color = true;
                        switch (Utility.RandomMinMax(0, 2))
                        {
