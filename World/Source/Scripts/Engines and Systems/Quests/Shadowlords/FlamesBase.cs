            ...
            else
            {
                ...
                if (ItemType == 1)
                {
                    ...
                    foreach (Item item in World.Items.Values)
                        if (item is BookOfTruth && ((BookOfTruth)item).Owner == from)
                        {
                            books.Add(item);
                        }
                    ...
                    BookOfTruth rwd = new BookOfTruth();
                    rwd.Owner = from;
                ...
                else if (ItemType == 2)
                {
                    ...
                    foreach (Item item in World.Items.Values)
                        if (item is BellOfCourage && ((BellOfCourage)item).Owner == from)
                        {
                            bells.Add(item);
                        }
                    ...
                    BellOfCourage rwd = new BellOfCourage();
                    rwd.Owner = from;
                    from.AddToBackpack(rwd);
                }
                else
                {
                    ...
                    foreach (Item item in World.Items.Values)
                        if (item is CandleOfLove && ((CandleOfLove)item).Owner == from)
                        {
                            candles.Add(item);
                        }
                    ...
                    CandleOfLove rwd = new CandleOfLove();
                    rwd.Owner = from;
                    from.AddToBackpack(rwd);
                }
