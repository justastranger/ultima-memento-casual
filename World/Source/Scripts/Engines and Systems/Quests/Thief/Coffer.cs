...
namespace Server.Items
{
    ...
    public class Coffer : Container
    {
        ...
        public static void SetupCoffer(Coffer coffer)
        {
            ...
            {
                ResourceMods.SetRandomResource(false, false, coffer, CraftResource.RegularWood, false, null);
                coffer.Hue = CraftResources.GetHue(coffer.Resource);
            }

            int money1 = (int)(250 * (MyServerSettings.GetGoldCutRate() * .01));
            int money2 = (int)(500 * (MyServerSettings.GetGoldCutRate() * .01));
