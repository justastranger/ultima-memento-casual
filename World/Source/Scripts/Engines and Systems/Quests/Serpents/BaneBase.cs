            ...
            else
            {
                ...
                if (ItemType == 1)
                {
                    ...
                    foreach (Item item in World.Items.Values)
                        if (item is ScalesOfEthicality && ((ScalesOfEthicality)item).Owner == from)
                        {
                            books.Add(item);
                        }
                    ...
                    ScalesOfEthicality rwd = new ScalesOfEthicality();
                    rwd.Owner = from;
                    from.AddToBackpack(rwd);
                }
                else if (ItemType == 2)
                {
                    ...
                    foreach (Item item in World.Items.Values)
                        if (item is OrbOfLogic && ((OrbOfLogic)item).Owner == from)
                        {
                            bells.Add(item);
                        }
                ...
                else
                {
                    ...
                    foreach (Item item in World.Items.Values)
                        if (item is LanternOfDiscipline && ((LanternOfDiscipline)item).Owner == from)
                        {
                            candles.Add(item);
                        }
                    ...
                    LanternOfDiscipline rwd = new LanternOfDiscipline();
                    rwd.Owner = from;
                    from.AddToBackpack(rwd);
                }
