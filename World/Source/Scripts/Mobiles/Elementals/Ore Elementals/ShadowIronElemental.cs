...
namespace Server.Mobiles
{
    ...
    public class ShadowIronElemental : BaseCreature
    {
        ...
        [Constructable]
        public ShadowIronElemental(int rocksAmount) : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        [Constructable]
        public ShadowIronElemental() : this(Utility.RandomMinMax(5, 10))
        {
        }
