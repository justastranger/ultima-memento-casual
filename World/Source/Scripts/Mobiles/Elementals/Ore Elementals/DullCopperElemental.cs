...
namespace Server.Mobiles
{
    ...
    public class DullCopperElemental : BaseCreature
    {
        ...
        [Constructable]
        public DullCopperElemental(int rocksAmount) : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        [Constructable]
        public DullCopperElemental() : this(Utility.RandomMinMax(5, 10))
        {
        }
