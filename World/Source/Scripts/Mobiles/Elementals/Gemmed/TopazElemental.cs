...
namespace Server.Mobiles
{
    ...
    public class TopazElemental : BaseCreature
    {
        ...
        [Constructable]
        public TopazElemental() : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Name = "a topaz elemental";
            Body = 322;
            BaseSoundID = 268;
            Hue = 0x488;
        ...
        public TopazElemental(Serial serial) : base(serial)
        {
        }
