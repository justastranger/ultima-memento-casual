...
namespace Server.Mobiles
{
    ...
    public class DilithiumElemental : BaseCreature
    {
        ...
        [Constructable]
        public DilithiumElemental() : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Name = "a dilithium elemental";
            Body = 322;
            BaseSoundID = 268;
            Hue = 0xB54;
        ...
        public override void OnDeath(Container c)
        {
            ...
            crystal.Name = "dilithium crystals";
            c.DropItem(crystal);
        }
        ...
        public DilithiumElemental(Serial serial) : base(serial)
        {
        }
