...
namespace Server.Mobiles
{
    ...
    public class CaddelliteElemental : BaseCreature
    {
        ...
        [Constructable]
        public CaddelliteElemental() : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Name = "a caddellite elemental";
        ...
        public CaddelliteElemental(Serial serial) : base(serial)
        {
        }
