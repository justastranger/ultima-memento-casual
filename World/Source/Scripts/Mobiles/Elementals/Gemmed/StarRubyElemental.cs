...
namespace Server.Mobiles
{
    ...
    public class StarRubyElemental : BaseCreature
    {
        ...
        [Constructable]
        public StarRubyElemental() : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Name = "a star ruby elemental";
            Body = 322;
            BaseSoundID = 268;
            Hue = 0x48E;
        ...
        public StarRubyElemental(Serial serial) : base(serial)
        {
        }
