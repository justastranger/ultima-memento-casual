...
namespace Server.Mobiles
{
    ...
    public class QuartzElemental : BaseCreature
    {
        ...
        [Constructable]
        public QuartzElemental() : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public QuartzElemental(Serial serial) : base(serial)
        {
        }
