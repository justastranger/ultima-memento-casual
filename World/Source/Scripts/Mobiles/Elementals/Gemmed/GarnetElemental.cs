...
namespace Server.Mobiles
{
    ...
    public class GarnetElemental : BaseCreature
    {
        ...
        [Constructable]
        public GarnetElemental() : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Name = "a garnet elemental";
            Body = 322;
            BaseSoundID = 268;
            Hue = 0x48F;
        ...
        public GarnetElemental(Serial serial) : base(serial)
        {
        }
