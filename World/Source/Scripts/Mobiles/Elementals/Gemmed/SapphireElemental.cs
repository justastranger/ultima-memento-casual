...
namespace Server.Mobiles
{
    ...
    public class SapphireElemental : BaseCreature
    {
        ...
        [Constructable]
        public SapphireElemental() : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Name = "a sapphire elemental";
            Body = 322;
            BaseSoundID = 268;
            Hue = 0x5B6;
            Resource = CraftResource.SapphireBlock;
        ...
        public SapphireElemental(Serial serial) : base(serial)
        {
        }
