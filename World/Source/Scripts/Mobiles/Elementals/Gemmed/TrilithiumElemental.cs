...
namespace Server.Mobiles
{
    ...
    public class TrilithiumElemental : BaseCreature
    {
        ...
        [Constructable]
        public TrilithiumElemental() : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Name = "a trilithium elemental";
            Body = 322;
            BaseSoundID = 268;
            Hue = 0xB3E;
        ...
        public TrilithiumElemental(Serial serial) : base(serial)
        {
        }
