...
namespace Server.Mobiles
{
    ...
    public class ForestElemental : BaseCreature
    {
        ...
        [Constructable]
        public ForestElemental() : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Name = "a forest elemental";
            Body = 196;
            BaseSoundID = 655;
        ...
        public ForestElemental(Serial serial)
            : base(serial)
        {
        }
