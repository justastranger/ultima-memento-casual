...
namespace Server.Mobiles
{
    ...
    public class EvilIcyVortex : BaseCreature
    {
        public override bool AlwaysAttackable { get { return true; } }
        public override bool DeleteCorpseOnDeath { get { return true; } }

        [Constructable]
        public EvilIcyVortex() : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Name = "an icy vortex";
            Body = 13;
            BaseSoundID = 655;
        ...
        public EvilIcyVortex(Serial serial) : base(serial)
        {
        }
