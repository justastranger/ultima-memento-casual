...
namespace Server.Mobiles
{
    ...
    public class GargoyleRuby : BaseCreature
    {
        [Constructable]
        public GargoyleRuby() : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Name = "a ruby gargoyle";
            Body = 185;
            BaseSoundID = 357;
            Resource = CraftResource.RubyBlock;
        ...
        public GargoyleRuby(Serial serial) : base(serial)
        {
        }
