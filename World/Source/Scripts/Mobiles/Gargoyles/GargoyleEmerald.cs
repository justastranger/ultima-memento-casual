...
namespace Server.Mobiles
{
    ...
    public class GargoyleEmerald : BaseCreature
    {
        [Constructable]
        public GargoyleEmerald() : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Name = "an emerald gargoyle";
            Body = 185;
            BaseSoundID = 357;
            Resource = CraftResource.EmeraldBlock;
        ...
        public GargoyleEmerald(Serial serial) : base(serial)
        {
        }
