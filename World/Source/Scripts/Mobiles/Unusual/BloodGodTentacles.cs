...
namespace Server.Mobiles
{
    ...
    public class BloodGodTentacles : BaseCreature
    {
        ...
        public BloodGodTentacles(Mobile harrower) : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            Name = "tentacles of the blood god";
            Body = 8;
            Hue = 1645;
        ...
        public BloodGodTentacles(Serial serial) : base(serial)
        {
        }
        ...
        {
            private BloodGodTentacles m_Owner;

            public DrainTimer(BloodGodTentacles owner) : base(TimeSpan.FromSeconds(5.0), TimeSpan.FromSeconds(5.0))
            {
                m_Owner = owner;
