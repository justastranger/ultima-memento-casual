                ...
                if (winner != null)
                {
                    ...
                    if (winner is PlayerMobile && !winner.Blessed)
                    {
                        ...
                        if (p != null)
                        {
                            ...
                            {
                                if (pmi.Mobile is PlayerMobile && pmi.Mobile.InRange(this.Location, 20) && pmi.Mobile.Map == this.Map && !pmi.Mobile.Blessed && pmi.Mobile.StatCap < (MySettings.S_StatCap + 50) && !Server.Misc.PlayerSettings.GetSpecialsKilled(pmi.Mobile, "TitanPyros"))
                                {
                        ...
                        else if (winner.StatCap < (MySettings.S_StatCap + 50) && !Server.Misc.PlayerSettings.GetSpecialsKilled(winner, "TitanPyros"))
                        {
