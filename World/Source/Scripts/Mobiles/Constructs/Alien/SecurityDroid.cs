...
namespace Server.Mobiles
{
    ...
    public class SecurityDroid : BaseCreature
    {
        ...
        [Constructable]
        public SecurityDroid() : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Name = Server.Misc.RandomThings.GetRandomRobot(1);
            Title = "the security droid";
            Body = 752;
            BaseSoundID = 1368;
        ...
        public override int Metal { get { return Utility.RandomMinMax(15, 50); } }
        public override MetalType MetalType { get { return MetalType.SciFi; } }
        ...
        {
            if (Utility.RandomMinMax(1, 3) == 1) { reflect = true; } // 33% spells are reflected back to the caster
            else { reflect = false; }
        }

        public SecurityDroid(Serial serial) : base(serial)
        {
        }
