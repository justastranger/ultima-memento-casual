...
namespace Server.Mobiles
{
    ...
    public class LivingJadeStatue : BaseCreature
    {
        private bool m_Stunning;

        [Constructable]
        public LivingJadeStatue() : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Name = "a jade statue";
            Body = 876;
            BaseSoundID = 268;
            Resource = CraftResource.JadeBlock;
            Hue = 0xB93;
        ...
        public LivingJadeStatue(Serial serial) : base(serial)
        {
        }
