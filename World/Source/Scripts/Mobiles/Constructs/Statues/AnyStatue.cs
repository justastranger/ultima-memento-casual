...
namespace Server.Mobiles
{
    ...
    public class AnyStatue : BaseCreature
    {
        ...
        public AnyStatue() : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            {
                case 1: RealName = "a golden sculpture"; Resource = CraftResource.Gold; break;
                case 2: RealName = "an iron sculpture"; Resource = CraftResource.Iron; break;
                case 3: RealName = "a jade sculpture"; Resource = CraftResource.JadeBlock; break;
                case 4: RealName = "a marble sculpture"; Resource = CraftResource.MarbleBlock; break;
                case 5: RealName = "a shadow iron sculpture"; Resource = CraftResource.ShadowIron; break;
                case 6: RealName = "a silver sculpture"; Resource = CraftResource.SilverBlock; break;
                case 7: RealName = "a stone sculpture"; Resource = CraftResource.Iron; break;
                case 8: RealName = "a bronze sculpture"; Resource = CraftResource.Bronze; break;
            }
