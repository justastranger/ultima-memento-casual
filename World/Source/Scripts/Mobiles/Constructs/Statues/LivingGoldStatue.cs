...
namespace Server.Mobiles
{
    ...
    public class LivingGoldStatue : BaseCreature
    {
        private bool m_Stunning;

        [Constructable]
        public LivingGoldStatue() : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public LivingGoldStatue(Serial serial) : base(serial)
        {
        }
