...
namespace Server.Mobiles
{
    ...
    public class LivingStoneStatue : BaseCreature
    {
        private bool m_Stunning;

        [Constructable]
        public LivingStoneStatue() : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Name = "a stone statue";
            Body = 876;
            BaseSoundID = 268;
        ...
        public LivingStoneStatue(Serial serial) : base(serial)
        {
        }
