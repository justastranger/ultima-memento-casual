...
namespace Server.Mobiles
{
    ...
    public class LivingMarbleStatue : BaseCreature
    {
        private bool m_Stunning;

        [Constructable]
        public LivingMarbleStatue() : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public LivingMarbleStatue(Serial serial) : base(serial)
        {
        }
