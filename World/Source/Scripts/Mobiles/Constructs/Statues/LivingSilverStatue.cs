...
namespace Server.Mobiles
{
    ...
    public class LivingSilverStatue : BaseCreature
    {
        private bool m_Stunning;

        [Constructable]
        public LivingSilverStatue() : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Name = "a silver statue";
            Body = 876;
        ...
        public LivingSilverStatue(Serial serial) : base(serial)
        {
        }
