...
namespace Server.Mobiles
{
    ...
    public class AbyssGiant : BaseCreature
    {
        ...
        [Constructable]
        public AbyssGiant() : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Name = NameList.RandomName("giant");
            Title = "the abysmal giant";
            Body = 772;
            BaseSoundID = 609;
        ...
        public AbyssGiant(Serial serial) : base(serial)
        {
        }
