...
namespace Server.Mobiles
{
    ...
    public class StarGiant : BaseCreature
    {
        ...
        public override void BreathDealDamage(Mobile target, int form) { base.BreathDealDamage(target, 45); }
        ...
        [Constructable]
        public StarGiant() : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Name = NameList.RandomName("giant");
            Title = "the star giant";
            BaseSoundID = 609;
            Hue = 0xB73;
            Body = Utility.RandomList(770, 771);
            ...
            if (killer != null)
            {
                ...
                if (killer is PlayerMobile)
                {
                    if (GetPlayerInfo.LuckyKiller(killer.Luck) && Utility.RandomMinMax(1, 4) == 1)
                    {
                        ...
                        MyChest.Name = "star giant chest";
                        MyChest.Hue = Utility.RandomList(0xBAD, 0xBAE, 0xBAF);
                        c.DropItem(MyChest);
                    }
                }
            }
        ...
        public StarGiant(Serial serial) : base(serial)
        {
        }
