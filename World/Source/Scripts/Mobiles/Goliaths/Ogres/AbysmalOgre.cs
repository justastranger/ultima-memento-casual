...
namespace Server.Mobiles
{
    ...
    public class AbysmalOgre : BaseCreature
    {
        ...
        [Constructable]
        public AbysmalOgre() : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Name = "an abysmal ogre";
            Body = 428;
            BaseSoundID = 427;
        ...
        public AbysmalOgre(Serial serial) : base(serial)
        {
        }
