...
{
    [CorpseName("a tuskadon corpse")]
    public class Tuskadon : BaseCreature
    {
        [Constructable]
        public Tuskadon() : base(AIType.AI_Animal, FightMode.Aggressor, 10, 1, 0.2, 0.4)
        {
            Name = "a tuskadon";
            Body = 376;
            BaseSoundID = 0x560;
        ...
        public Tuskadon(Serial serial) : base(serial)
        {
        }
