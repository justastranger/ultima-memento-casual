    ...
    public class EtherealMount : Item, IMount, IMountItem
    {
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            else
            {
                ...
                else if (this is Warhorse) { Hue = 0; m_RegularID = 0x55DC; m_MountedID = 594; ItemID = 0x55DC; }
                ...
                else if (this is EtherealReptalon) { m_RegularID = 0x2d95; m_MountedID = 384; }
        ...
        public static void EthyDismount(Mobile m)
        {
            IMount mount = m.Mount;

            if (mount != null && mount is EtherealMount)
            {
