...
namespace Server.Mobiles
{
    ...
    public class Brontosaur : BaseCreature
    {
        ...
        [Constructable]
        public Brontosaur() : base(AIType.AI_Animal, FightMode.Aggressor, 10, 1, 0.2, 0.4)
        {
            Name = "a brontosaur";
            Body = 934;
            BaseSoundID = 362;
        ...
        public Brontosaur(Serial serial) : base(serial)
        {
        }
