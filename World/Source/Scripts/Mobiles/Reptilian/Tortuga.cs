...
{
    [CorpseName("a tortuga corpse")]
    public class Tortuga : BaseCreature
    {
        [Constructable]
        public Tortuga() : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Name = "a tortuga";
            Body = 240;
        ...
        public Tortuga(Serial serial) : base(serial)
        {
        }
