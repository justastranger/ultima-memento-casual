...
namespace Server.Mobiles
{
    ...
    public class SandSquid : BaseCreature
    {
        [Constructable]
        public SandSquid() : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Name = "a sand squid";
            Body = 391;
            BaseSoundID = 353;
            Hue = Utility.RandomList(2931, 2894, 2895);
        ...
        public SandSquid(Serial serial) : base(serial)
        {
        }
