                    ...
                    for (int i = 0; i < newmonsters; ++i)
                    {
                        ...
                        else if (from.EmoteHue == 14)
                        {
                            switch (Utility.Random(5))
                            {
                                default:
                                case 0:
                                case 1: monster = new DeathWolf(); break;
