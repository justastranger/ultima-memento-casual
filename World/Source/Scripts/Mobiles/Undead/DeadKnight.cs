...
namespace Server.Mobiles
{
    ...
    public class DeadKnight : BaseCreature
    {
        ...
        public override void OnAfterSpawn()
        {
            ...
            if (this.Hue == 1150) { MorphingTime.BlessMyClothes(this); MorphingTime.ColorMyClothes(this, 1150, 0); }
            else if (this.Hue == 0xB97) { MorphingTime.ColorMyClothes(this, 0xB9A, 0); }
            else
            {
