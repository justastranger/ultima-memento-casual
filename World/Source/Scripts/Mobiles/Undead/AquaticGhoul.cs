...
namespace Server.Mobiles
{
    ...
    public class AquaticGhoul : BaseCreature
    {
        ...
        [Constructable]
        public AquaticGhoul() : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Name = "an aquatic ghoul";
            Body = 181;
            Hue = 681;
            BaseSoundID = 471;
            CanSwim = true;
        ...
        public AquaticGhoul(Serial serial) : base(serial)
        {
        }
