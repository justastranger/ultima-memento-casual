    ...
    public class EpicCharacter : BasePerson
    {
        ...
        public class EpicBookGump : Gump
        {
            public EpicBookGump(Mobile from, Mobile giver, int page, bool pay) : base(100, 100)
            {
                ...
                y = y + z;
                if (Server.Items.ManualOfItems.GetRelicArtyForBook(showItem1, 1) != "") { AddButton(x, y, 2447, 2447, showItem1, GumpButtonType.Reply, 0); }
                y = y + z;
                if (Server.Items.ManualOfItems.GetRelicArtyForBook(showItem2, 1) != "") { AddButton(x, y, 2447, 2447, showItem2, GumpButtonType.Reply, 0); }
                y = y + z;
                if (Server.Items.ManualOfItems.GetRelicArtyForBook(showItem3, 1) != "") { AddButton(x, y, 2447, 2447, showItem3, GumpButtonType.Reply, 0); }
                y = y + z;
                if (Server.Items.ManualOfItems.GetRelicArtyForBook(showItem4, 1) != "") { AddButton(x, y, 2447, 2447, showItem4, GumpButtonType.Reply, 0); }
                y = y + z;
                if (Server.Items.ManualOfItems.GetRelicArtyForBook(showItem5, 1) != "") { AddButton(x, y, 2447, 2447, showItem5, GumpButtonType.Reply, 0); }
                y = y + z;
                if (Server.Items.ManualOfItems.GetRelicArtyForBook(showItem6, 1) != "") { AddButton(x, y, 2447, 2447, showItem6, GumpButtonType.Reply, 0); }
                y = y + z;
                if (Server.Items.ManualOfItems.GetRelicArtyForBook(showItem7, 1) != "") { AddButton(x, y, 2447, 2447, showItem7, GumpButtonType.Reply, 0); }
                y = y + z;
                if (Server.Items.ManualOfItems.GetRelicArtyForBook(showItem8, 1) != "") { AddButton(x, y, 2447, 2447, showItem8, GumpButtonType.Reply, 0); }
                y = s - 3;
                y = y + z;
                ...
                y = y + z;
                if (Server.Items.ManualOfItems.GetRelicArtyForBook(showItem9, 1) != "") { AddButton(x, y, 2447, 2447, showItem9, GumpButtonType.Reply, 0); }
                y = y + z;
                if (Server.Items.ManualOfItems.GetRelicArtyForBook(showItem10, 1) != "") { AddButton(x, y, 2447, 2447, showItem10, GumpButtonType.Reply, 0); }
                y = y + z;
                if (Server.Items.ManualOfItems.GetRelicArtyForBook(showItem11, 1) != "") { AddButton(x, y, 2447, 2447, showItem11, GumpButtonType.Reply, 0); }
                y = y + z;
                if (Server.Items.ManualOfItems.GetRelicArtyForBook(showItem12, 1) != "") { AddButton(x, y, 2447, 2447, showItem12, GumpButtonType.Reply, 0); }
                y = y + z;
                if (Server.Items.ManualOfItems.GetRelicArtyForBook(showItem13, 1) != "") { AddButton(x, y, 2447, 2447, showItem13, GumpButtonType.Reply, 0); }
                y = y + z;
                if (Server.Items.ManualOfItems.GetRelicArtyForBook(showItem14, 1) != "") { AddButton(x, y, 2447, 2447, showItem14, GumpButtonType.Reply, 0); }
                y = y + z;
                if (Server.Items.ManualOfItems.GetRelicArtyForBook(showItem15, 1) != "") { AddButton(x, y, 2447, 2447, showItem15, GumpButtonType.Reply, 0); }
                y = y + z;
                if (Server.Items.ManualOfItems.GetRelicArtyForBook(showItem16, 1) != "") { AddButton(x, y, 2447, 2447, showItem16, GumpButtonType.Reply, 0); }
                y = s - 3;
                y = y + z;
