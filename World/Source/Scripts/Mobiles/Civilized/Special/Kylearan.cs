    ...
    public class Kylearan : BaseNPC
    {
        ...
        public class KylearanEntry : ContextMenuEntry
        {
            ...
            public override void OnClick()
            {
                ...
                {
                    PlayerSettings.SetBardsTaleQuest(m_Mobile, "BardsTaleEbonyKey", true);
                    m_Mobile.SendSound(0x3D);
                    m_Mobile.SendGump(new SpeechGump(m_Mobile, "Thank You Brave Adventurer", SpeechFunctions.SpeechText(m_Giver, m_Mobile, "Kylearan")));

                    ManualOfItems book = new ManualOfItems();
                    book.Hue = 0xA20;
                    book.Name = "Chest of Kylearan Relics";
                    book.m_Charges = 1;
                    book.m_Skill_1 = 17;
                    book.m_Skill_2 = 31;
                    book.m_Skill_3 = 32;
