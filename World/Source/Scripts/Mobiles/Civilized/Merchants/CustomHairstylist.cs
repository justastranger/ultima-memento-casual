...
namespace Server.Mobiles
{
    public class CustomHairstylist : BaseVendor
    {
        ...
        private class BarberEntry : ContextMenuEntry
        {
            ...
            public BarberEntry(CustomHairstylist CustomHairstylist, Mobile from) : base(6120, 12)
            {
                ...
                m_From = from;
                Enabled = CustomHairstylist.CheckVendorAccess(from);
            }
        ...
        {
            if (CheckChattingAccess(from) && from.RaceID < 1)
        ...
        public class MyStock : SBInfo
        {
            ...
            public class InternalBuyInfo : List<GenericBuyInfo>
            {
                ...
                {
                    ItemInformation.GetSellList(m_Merchant, this, ItemSalesInfo.Category.None, ItemSalesInfo.Material.None, ItemSalesInfo.Market.Barber, ItemSalesInfo.World.None, null);
                }
            }
            ...
            public class InternalSellInfo : GenericSellInfo
            {
                ...
                {
                    ItemInformation.GetBuysList(m_Merchant, this, ItemSalesInfo.Category.None, ItemSalesInfo.Material.None, ItemSalesInfo.Market.Barber, ItemSalesInfo.World.None, null);
                }
            }
        }
    ...
    public class ChangeHairstyleEntry
    {
        ...
        public static readonly ChangeHairstyleEntry[] HairEntries = new ChangeHairstyleEntry[]
            {
                new ChangeHairstyleEntry( 50700,  70 - 137,  20 -  60, 0x203B ), // SHORT HAIR
				new ChangeHairstyleEntry( 60710, 193 - 260,  18 -  60, 0x2045 ), // PAGE BOY
				new ChangeHairstyleEntry( 50703, 316 - 383,  25 -  60, 0x2044 ), // MOHAWK
				new ChangeHairstyleEntry( 60701,  70 - 137,  75 - 125, 0x203C ), // LONG HAIR
				new ChangeHairstyleEntry( 60900, 193 - 260,  85 - 125, 0x2047 ), // AFRO
				new ChangeHairstyleEntry( 60903, 320 - 383,  85 - 125, 0x204A ), // KRISNA
				new ChangeHairstyleEntry( 60702,  70 - 137, 140 - 190, 0x203D ), // PONY TAIL
				new ChangeHairstyleEntry( 60902, 193 - 260, 140 - 190, 0x2049 ), // PIG TAILS
        ...
        public static readonly ChangeHairstyleEntry[] BeardEntries = new ChangeHairstyleEntry[]
            {
                new ChangeHairstyleEntry( 50800, 120 - 187,  30 -  80, 0x2040 ), // GOATEE
				new ChangeHairstyleEntry( 50904, 243 - 310,  33 -  80, 0x204B ), // MED SHORT BEARD
				...
				new ChangeHairstyleEntry( 50905, 243 - 310, 165 - 220, 0x204C ), // MED LONG BEARD
				new ChangeHairstyleEntry( 50803, 120 - 187, 242 - 290, 0x2041 ), // MUSTACHE
				new ChangeHairstyleEntry( 0, 0, 0, 0 )
            };
    }
