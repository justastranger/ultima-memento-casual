...
namespace Server.Mobiles
{
    public class Banker : BaseVendor
    {
        ...
        public override string TalkGumpTitle { get { return "Copper and Silver Coins"; } }
        public override string TalkGumpSubject { get { return "Banker"; } }
        ...
        public class MyStock : SBInfo
        {
            ...
            public class InternalBuyInfo : List<GenericBuyInfo>
            {
                ...
                {
                    ItemInformation.GetSellList(m_Merchant, this, ItemSalesInfo.Category.None, ItemSalesInfo.Material.None, ItemSalesInfo.Market.Banker, ItemSalesInfo.World.None, null);
                }
            }
            ...
            public class InternalSellInfo : GenericSellInfo
            {
                ...
                {
                    ItemInformation.GetBuysList(m_Merchant, this, ItemSalesInfo.Category.None, ItemSalesInfo.Material.None, ItemSalesInfo.Market.Banker, ItemSalesInfo.World.None, null);
                }
            }
        }
                        ...
                        case 0x0001: // *balance*
                            {
                                ...
                                if (box != null)
                                    this.Say(1042759, (GetPlayerInfo.GetBankedGold(e.Mobile)).ToString()); // Thy current bank balance is ~1_AMOUNT~ gold.
                                else
