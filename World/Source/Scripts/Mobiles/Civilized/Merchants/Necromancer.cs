		...
		public class MyStock: SBInfo
		{
			...
			public class InternalSellInfo : GenericSellInfo
			{
				public InternalSellInfo()
				{
					...
					ItemInformation.GetBuysList( m_Merchant, this, 	ItemSalesInfo.Category.Weapon,		ItemSalesInfo.Material.All,		ItemSalesInfo.Market.Necro,		ItemSalesInfo.World.None,	null	 );
