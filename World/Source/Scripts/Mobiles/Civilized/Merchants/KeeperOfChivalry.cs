...
namespace Server.Mobiles
{
    public class KeeperOfChivalry : BaseVendor
    {
        ...
        public override string TalkGumpTitle { get { return "The Road To Knighthood"; } }
        ...
        public class MyStock : SBInfo
        {
            ...
            public class InternalBuyInfo : List<GenericBuyInfo>
            {
                ...
                {
                    ItemInformation.GetSellList(m_Merchant, this, ItemSalesInfo.Category.All, ItemSalesInfo.Material.All, ItemSalesInfo.Market.Paladin, ItemSalesInfo.World.None, null);
            ...
            public class InternalSellInfo : GenericSellInfo
            {
                ...
                {
                    ItemInformation.GetBuysList(m_Merchant, this, ItemSalesInfo.Category.All, ItemSalesInfo.Material.All, ItemSalesInfo.Market.Paladin, ItemSalesInfo.World.None, null);
