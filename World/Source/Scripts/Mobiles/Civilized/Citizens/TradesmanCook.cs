    ...
    public class StoveHit : Item
    {
        ...
        public override void OnDoubleClick(Mobile from)
        {
            if (from is Citizens)
            {
                ...
                else if (ItemID == 0x568E) { ItemID = Utility.RandomList(0x568C, 0x568D); from.PlaySound(Utility.RandomList(0x059, 0x057)); }
            }
        }
    ...
    public class CrateOfFood : Item
    {
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            else
            {
                ...
                from.PrivateOverheadMessage(MessageType.Regular, 0x14C, false, "You separate the food into your backpack", from.NetState);
                this.Delete();
            }
        }
