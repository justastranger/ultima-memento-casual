...
namespace Server.Mobiles
{
    ...
    public class BottleDragon : BaseCreature
    {
        ...
        [Constructable]
        public BottleDragon() : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public override int Scales { get { return 14; } }
        ...
        public BottleDragon(Serial serial) : base(serial)
        {
        }
