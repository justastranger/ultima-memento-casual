...
namespace Server.Mobiles
{
    ...
    public class PrimevalRoyalDragon : BaseCreature
    {
        ...
        [Constructable]
        public PrimevalRoyalDragon() : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public override void OnDeath(Container c)
        {
            ...
            if (killer != null)
            {
                ...
                {
                    Server.Mobiles.Dragons.DropSpecial(this, killer, this.Name + " " + this.Title, c, 10, 0x494);
                }
            }
        }
        ...
        public PrimevalRoyalDragon(Serial serial) : base(serial)
        {
        }
