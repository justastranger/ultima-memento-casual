...
namespace Server.Mobiles
{
    ...
    public class PrimevalDragon : BaseCreature
    {
        ...
        [Constructable]
        public PrimevalDragon() : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public PrimevalDragon(Serial serial) : base(serial)
        {
        }
