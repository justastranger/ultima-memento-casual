...
namespace Server.Mobiles
{
    ...
    public class PrimevalBlackDragon : BaseCreature
    {
        ...
        [Constructable]
        public PrimevalBlackDragon() : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Name = NameList.RandomName("dragon");
            Title = "the primeval black dragon";
            Body = 123;
            BaseSoundID = 362;
        ...
        public override void OnDeath(Container c)
        {
            ...
            if (killer != null)
            {
                ...
                {
                    Server.Mobiles.Dragons.DropSpecial(this, killer, this.Name + " " + this.Title, c, 10, 0x497);
                }
            }
        }
        ...
        public PrimevalBlackDragon(Serial serial) : base(serial)
        {
        }
