...
namespace Server.Mobiles
{
    ...
    public class PrimevalStygianDragon : BaseCreature
    {
        ...
        [Constructable]
        public PrimevalStygianDragon() : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            if (Utility.RandomBool())
                Resource = CraftResource.BrazenScales;
        ...
        public override void OnDeath(Container c)
        {
            ...
            if (killer != null)
            {
                ...
                {
                    Server.Mobiles.Dragons.DropSpecial(this, killer, this.Name + " " + this.Title, c, 10, 0xB98);
                }
            }
        }
        ...
        public PrimevalStygianDragon(Serial serial) : base(serial)
        {
        }
