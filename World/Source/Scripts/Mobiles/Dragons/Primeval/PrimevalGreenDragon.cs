...
namespace Server.Mobiles
{
    ...
    public class PrimevalGreenDragon : BaseCreature
    {
        ...
        [Constructable]
        public PrimevalGreenDragon() : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Name = NameList.RandomName("dragon");
            Title = "the primeval green dragon";
            Body = 721;
            BaseSoundID = 362;
        ...
        public override void OnDeath(Container c)
        {
            ...
            if (killer != null)
            {
                ...
                {
                    Server.Mobiles.Dragons.DropSpecial(this, killer, this.Name + " " + this.Title, c, 10, 0x9E7);
                }
            }
        }
        ...
        public PrimevalGreenDragon(Serial serial) : base(serial)
        {
        }
