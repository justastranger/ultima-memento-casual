...
namespace Server.Mobiles
{
    ...
    public class PrimevalVolcanicDragon : BaseCreature
    {
        ...
        [Constructable]
        public PrimevalVolcanicDragon() : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Name = NameList.RandomName("dragon");
            Title = "the cinder dragon";
            Body = 713;
            BaseSoundID = 362;
        ...
        public override void OnDeath(Container c)
        {
            ...
            if (killer != null)
            {
                ...
                {
                    Server.Mobiles.Dragons.DropSpecial(this, killer, this.Name + " " + this.Title, c, 10, 0xB85);
                }
            }
        }
        ...
        public PrimevalVolcanicDragon(Serial serial) : base(serial)
        {
        }
