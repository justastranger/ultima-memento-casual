...
namespace Server.Mobiles
{
    ...
    public class PrimevalSilverDragon : BaseCreature
    {
        ...
        [Constructable]
        public PrimevalSilverDragon() : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Name = NameList.RandomName("dragon");
            Title = "the primeval silver dragon";
            Body = 175;
            BaseSoundID = 362;
        ...
        public override void OnDeath(Container c)
        {
            ...
            if (killer != null)
            {
                ...
                {
                    Server.Mobiles.Dragons.DropSpecial(this, killer, this.Name + " " + this.Title, c, 10, 0x430);
                }
            }
        }
        ...
        public PrimevalSilverDragon(Serial serial) : base(serial)
        {
        }
