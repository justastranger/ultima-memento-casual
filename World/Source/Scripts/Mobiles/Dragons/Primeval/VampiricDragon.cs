    ...
    public class VampiricDragon : BaseCreature
    {
        ...
        public override void OnDeath(Container c)
        {
            ...
            if (killer != null)
            {
                ...
                {
                    Server.Mobiles.Dragons.DropSpecial(this, killer, this.Name + " " + this.Title, c, 10, 0xA45);
        ...
        public override SkeletalType SkeletalType { get { if (Utility.RandomBool()) { return SkeletalType.Draco; } else { return SkeletalType.Vampire; } } }
