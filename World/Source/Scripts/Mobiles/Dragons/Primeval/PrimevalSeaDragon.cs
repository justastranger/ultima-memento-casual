    ...
    public class PrimevalSeaDragon : BaseCreature
    {
        ...
        public override void OnDeath(Container c)
        {
            ...
            if (killer != null)
            {
                ...
                {
                    Server.Mobiles.Dragons.DropSpecial(this, killer, this.Name + " " + this.Title, c, 10, 0xA14);
                }
            }
        }
        ...
        public override SkinType SkinType { get { if (Utility.RandomBool()) { return SkinType.Dragon; } else { return SkinType.Seaweed; } } }
