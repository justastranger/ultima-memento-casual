...
namespace Server.Mobiles
{
    ...
    public class PrimevalRedDragon : BaseCreature
    {
        ...
        [Constructable]
        public PrimevalRedDragon() : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Name = NameList.RandomName("dragon");
            Title = "the primeval red dragon";
            Body = 720;
            BaseSoundID = 362;
        ...
        public override void OnDeath(Container c)
        {
            ...
            if (killer != null)
            {
                ...
                {
                    Server.Mobiles.Dragons.DropSpecial(this, killer, this.Name + " " + this.Title, c, 10, 0x9C5);
                }
            }
        }
        ...
        public PrimevalRedDragon(Serial serial) : base(serial)
        {
        }
