...
namespace Server.Mobiles
{
    ...
    public class AbrozShaman : BaseCreature
    {
        ...
        [Constructable]
        public AbrozShaman() : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Name = "an ambroz shaman";
            Body = 250;
            BaseSoundID = 0x45A;
            ...
            SetSkill(SkillName.Psychology, 92.6, 107.5);
            ...
            SetSkill(SkillName.FistFighting, 47.6, 57.5);
