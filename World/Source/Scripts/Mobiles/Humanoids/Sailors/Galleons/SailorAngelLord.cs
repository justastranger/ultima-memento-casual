...
{
    public class SailorAngelLord : BasePirate
    {
        [Constructable]
        public SailorAngelLord()
        {
            ...
            if (Utility.RandomBool()) { ship = new GalleonExotic(); } else { ship = new GalleonRoyal(); }
        ...
        public SailorAngelLord(Serial serial) : base(serial)
        {
        }
