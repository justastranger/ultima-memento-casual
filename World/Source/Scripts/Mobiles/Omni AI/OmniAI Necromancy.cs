...
namespace Server.Mobiles
{
    public partial class OmniAI : BaseAI
    {
        ...
        public Spell GetNecromancerDamageSpell()
        {
            ...
            {
                case 0: case 1: case 2: return CheckForCurseWeapon();
                case 3: case 4: return new PoisonStrikeSpell(m_Mobile, null);
                case 5: case 6: return new WitherSpell(m_Mobile, null);
