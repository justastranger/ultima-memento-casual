...
namespace Server.Mobiles
{
    ...
    {
        [Constructable]
        public AITester() : this(12)
        {
        }

        [Constructable]
        public AITester(int i) : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Name = "Dark Knight";
            Body = 400;
            Hue = 1175;
        ...
        protected override BaseAI ForcedAI { get { return new OmniAI(this); } }
        public override bool AlwaysMurderer { get { return true; } }
        public override bool ShowFameTitle { get { return false; } }

        public AITester(Serial serial) : base(serial)
        {
        }
