...
namespace Server.Mobiles
{
    ...
    public class ClassicDaemon : BaseCreature
    {
        public override double DispelDifficulty { get { return 125.0; } }
        public override double DispelFocus { get { return 45.0; } }

        [Constructable]
        public ClassicDaemon() : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public ClassicDaemon(Serial serial) : base(serial)
        {
        }
