...
namespace Server.Mobiles
{
    ...
    public class ClassicBalron : BaseCreature
    {
        [Constructable]
        public ClassicBalron() : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public ClassicBalron(Serial serial) : base(serial)
        {
        }
