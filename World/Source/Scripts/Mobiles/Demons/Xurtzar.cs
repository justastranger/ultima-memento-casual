...
namespace Server.Mobiles
{
    ...
    public class Xurtzar : BaseCreature
    {
        ...
        public Xurtzar() : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            Body = 379;
            Hue = Utility.RandomList(2808, 2378);
            BaseSoundID = 357;
            EmoteHue = 123;
    ...
    public class XurtzarChest : Item
    {
        ...
        public override void OnDoubleClick(Mobile from)
        {
            if (from.InRange(this.GetWorldLocation(), 2))
            {
                ...
                {
                    if (GetPlayerInfo.LuckyKiller(from.Luck) && !Server.Misc.PlayerSettings.GetSpecialsKilled(from, "Xurtzar"))
                    {
                        ...
                        Server.Misc.PlayerSettings.SetSpecialsKilled(from, "Xurtzar", true);
                        ManualOfItems lexicon = new ManualOfItems();
                        lexicon.Hue = 0x490;
                        lexicon.Name = "Chest of Xurtzar Relics";
                        lexicon.m_Charges = 1;
                        lexicon.m_Skill_1 = 0;
                        lexicon.m_Skill_2 = 0;
                        lexicon.m_Skill_3 = 0;
