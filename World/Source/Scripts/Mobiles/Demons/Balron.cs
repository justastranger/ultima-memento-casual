...
namespace Server.Mobiles
{
    ...
    public class Balron : BaseCreature
    {
        ...
        public static void ExplodeDeath(Mobile from, int form)
        {
            ...
            {
                while (radius > count) { count++; Effects.SendLocationEffect(BlastZone(count, from.X, from.Y, from.Z), from.Map, 0x5590, 30, 10, Utility.RandomList(0xB4D, 0xB4E), 0); }
            ...
            else if (form == 46) // LARGE STORM ATTACK --------------------------------------------------------------------------------------------
            {
                ...
                {
                    count++;
                    Effects.SendLocationEffect(BlastZone(count, from.X, from.Y, from.Z), from.Map, 0x5590, 30, 10, 0xB24, 0);
            ...
            {
                while (radius > count) { count++; Effects.SendLocationEffect(BlastZone(count, from.X, from.Y, from.Z), from.Map, 0x5590, 30, 10, 0xB24, 0); }
                from.PlaySound(0x10B);
            }
        }
    }
