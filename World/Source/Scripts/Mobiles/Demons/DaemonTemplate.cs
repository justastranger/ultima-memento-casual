...
namespace Server.Mobiles
{
    ...
    public class DaemonTemplate : BaseCreature
    {
        [Constructable]
        public DaemonTemplate() : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Name = "a demon";
            Body = 9;
            BaseSoundID = 357;
        ...
        public DaemonTemplate(Serial serial) : base(serial)
        {
        }
