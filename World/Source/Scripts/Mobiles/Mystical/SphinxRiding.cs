...
namespace Server.Mobiles
{
    ...
    public class SphinxRiding : BaseMount
    {
        ...
        public override SkeletalType SkeletalType { get { return SkeletalType.Sphinx; } }

        [Constructable]
        public SphinxRiding() : this("a sphinx")
        {
        }

        [Constructable]
        public SphinxRiding(string name) : base(name, 788, 788, AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            BaseSoundID = 0x668;
        ...
        public SphinxRiding(Serial serial) : base(serial)
        {
        }
