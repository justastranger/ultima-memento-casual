...
{
    [CorpseName("a dreadhorn corpse")]
    public class Dreadhorn : BaseMount
    {
        ...
        [Constructable]
        public Dreadhorn(string name) : base(name, 354, 354, AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            BaseSoundID = 0x4BC;
        ...
        public override SkinType SkinType { get { return SkinType.Unicorn; } }
