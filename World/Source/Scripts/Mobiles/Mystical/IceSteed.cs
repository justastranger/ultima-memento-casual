...
namespace Server.Mobiles
{
    ...
    public class IceSteed : BaseMount
    {
        ...
        [Constructable]
        public IceSteed(string name) : base(name, 226, 0x3EA0, AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            BaseSoundID = 0xA8;
            Hue = 0xB78;
        ...
        {
            PackItem(new MoonCrystal(Utility.RandomMinMax(20, 50)));
            PackItem(new Sapphire(Utility.RandomMinMax(2, 5)));
        }
