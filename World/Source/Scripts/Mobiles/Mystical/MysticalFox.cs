...
namespace Server.Mobiles
{
    ...
    public class MysticalFox : BaseCreature
    {

        [Constructable]
        public MysticalFox() : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Name = "a mystical fox";
            Body = 246;
            ...
            SetSkill(SkillName.FistFighting, 50.1, 55.0);
        ...
        {
            if (Combatant == null && !IsBodyMod && RaceID < 1 && !Controlled && m_DisguiseTimer == null && Utility.RandomBool())
        ...
        {
            if (Combatant != null || (IsBodyMod && RaceID < 1) || Controlled)
                return;
        ...
        public MysticalFox(Serial serial) : base(serial)
        {
        }
