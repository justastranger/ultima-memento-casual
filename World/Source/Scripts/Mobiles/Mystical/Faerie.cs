...
{
    [CorpseName("a faerie corpse")]
    public class Faerie : BaseCreature
    {
        ...
        [Constructable]
        public Faerie() : base(AIType.AI_Mage, FightMode.Evil, 10, 1, 0.2, 0.4)
        {
            ...
            SetSkill(SkillName.FistFighting, 10.1, 12.5);
        ...
        public Faerie(Serial serial) : base(serial)
        {
        }
