...
namespace Server.Mobiles
{
    ...
    {
        [Constructable]
        public Reptalon() : base("a dragon", 0x114, 384, AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.35)
        {
            ...
            SetSkill(SkillName.FistFighting, 101.5, 118.2);
        ...
        {
            AddLoot(LootPack.MonsterUltraRich, 3);
        }
