...
namespace Server.Items
{
    public class HomePlants_Flower : Item
    {
        ...
        [Constructable]
        public HomePlants_Flower() : base(0xC84)
        {
            Weight = 2.0;
            Movable = true;
            Name = "flowers";
    ...
    public class HomePlants_Leaf : Item
    {
        ...
        [Constructable]
        public HomePlants_Leaf() : base(0xC9F)
        {
            Weight = 2.0;
            Movable = true;
            Name = "leafy plant";
    ...
    public class HomePlants_Cactus : Item
    {
        ...
        [Constructable]
        public HomePlants_Cactus() : base(0xD25)
        {
            Weight = 2.0;
            Movable = true;
            Name = "cactus";
    ...
    public class HomePlants_Lilly : Item
    {
        ...
        [Constructable]
        public HomePlants_Lilly() : base(0xC93)
        {
            Weight = 2.0;
            Movable = true;
            Name = "water plant";
    ...
    public class HomePlants_Grass : Item
    {
        ...
        [Constructable]
        public HomePlants_Grass() : base(0xCBA)
        {
            Weight = 2.0;
            Movable = true;
            Name = "grassy plant";
