...
{
    public class AllDyeTubsFurniture : DyeTub
    {
        ...
        public AllDyeTubsFurniture(Serial serial) : base(serial) { }
        ...
        public class AllDyeTubsFurnitureTarget : Target
        {
            private AllDyeTubsFurniture m_Tub;

            public AllDyeTubsFurnitureTarget(AllDyeTubsFurniture dyetub) : base(12, false, TargetFlags.None)
            {
                m_Tub = dyetub;
            }
