        ...
        private class WHueTarget : Target
        {
            ...
            protected override void OnTarget(Mobile from, object targeted)
            {
                ...
                if (obj is HueStone)
                {
                    ...
                    else if (iStone.Hue == 0x48E) { iStone.Hue = 0xB54; iStone.Name = "Illusionist Stone ( gold )"; }
                    else if (iStone.Hue == 0xB54) { iStone.Hue = 0x4AA; iStone.Name = "Illusionist Stone ( rose red )"; }
