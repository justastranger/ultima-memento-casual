...
namespace Server.Items
{
    public class EssenceBase : BaseAddon
    {
        ...
        public EssenceBase(string orb)
        {
            ...
            else if (orb == "radiated") { iPed = 0x22BD; iColor = ItemColor = 0xB79; ItemHairColor = 0xB51; sThing = ItemName = "Essence of the Radiated"; ItemType = "radiated"; }
            ...
            AddComplexComponent((BaseAddon)this, iPed, 0, 0, 0, 0, -1, "", 1);
        }
        ...
        public static bool ColorCitizen(Mobile m)
        {
            ...
            int nColor = Utility.RandomMinMax(1, 5);
            if (m is Citizens && Utility.RandomMinMax(1, 5) == 1)
                nColor = Utility.RandomMinMax(1, 12);

            if (m is Citizens)
                isColored = true;

            if (m is BaseVendor && Server.Misc.Worlds.IsSeaTown(m.Location, m.Map))
                isColored = true;

            if (isColored && Utility.RandomMinMax(1, 25) != 1)
                isColored = false;
            ...
            if (isColored)
            {
                switch (nColor)
                {
                    case 1: m.Hue = 0x1CB; m.HairHue = 0x455; break;
                    case 2: m.Hue = 0xACF; m.HairHue = 0xACC; break;
                    case 3: m.Hue = 0x555; m.HairHue = 0x554; break;
                    case 4: m.Hue = 1316; m.HairHue = 1150; break;
                    case 5: m.Hue = 0x497; m.HairHue = 1150; break;
                    case 6: m.Hue = 0x47E; m.HairHue = 0x497; break;
                    case 7: m.Hue = 0x47E; m.HairHue = 0x47E; break;
                    case 8: m.Hue = 0x5B5; m.HairHue = 0x497; break;
                    case 9: m.Hue = 0x497; m.HairHue = 0x497; break;
                    case 10: m.Hue = 0xB78; m.HairHue = 0x8D3; break;
                    case 11: m.Hue = 0xB17; m.HairHue = 0xB71; break;
                    case 12: m.Hue = 0xB79; m.HairHue = 0xB51; break;
                }
        ...
        public override void OnComponentUsed(AddonComponent ac, Mobile from)
        {
            ...
            else
            {
                ...
                if (!(from.Region is SavageRegion))
                {
                    ...
                    if (ItemColor == 0xB79 && ItemHairColor == 0xB51) { Pedul.ItemID = 0x22BD; }
