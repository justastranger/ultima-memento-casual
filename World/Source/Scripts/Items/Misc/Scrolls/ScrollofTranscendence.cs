...
namespace Server.Items
{
    public class ScrollofTranscendence : SpecialScroll
    {
        ...
        {
            SkillName skill = SpecialScroll.ScrollSkill(0);
        ...
        public override void GetProperties(ObjectPropertyList list)
        {
            ...
            if (Value == 1)
                list.Add(1076759, "{0}\t{1}.0 Skill Points", SkillInfo.Table[(int)Skill].Name, Value);
            else
                list.Add(1076759, "{0}\t{1} Skill Points", SkillInfo.Table[(int)Skill].Name, Value);
        }
