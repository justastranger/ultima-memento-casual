...
namespace Server.Items
{
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    public class AltarDryad : Item
    {
        [Constructable]
        public AltarDryad() : base(0x641E)
        {
            Movable = false;
            Name = "Shrine of the Ancient Dryad";
        }

        public AltarDryad(Serial serial) : base(serial)
        {
        }
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    public class AltarDurama : Item
    {
        [Constructable]
        public AltarDurama() : base(0x1947)
        {
            Movable = false;
            ItemID = Utility.RandomList(0x1947, 0x1948);
            Name = "Shrine of Durama";
            Hue = 0xB18;
        }

        public AltarDurama(Serial serial) : base(serial)
        {
        }
