...
namespace Server.Items
{
    ...
    public class NewHolidayTree : Item
    {
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            from.SendGump(new NewHolidayTreeGump(this, from));
        }
        ...
        public class NewHolidayTreeGump : Gump
        {
            ...
            public NewHolidayTreeGump(Item tree, Mobile from) : base(50, 50)
            {
                ...
                AddImage(0, 0, 11425);
                AddButton(762, 10, 4017, 4017, 0, GumpButtonType.Reply, 0);
                AddHtml(12, 234, 776, 61, @"<BODY><BASEFONT Color=" + color + ">Choose the type of holiday tree you want. You can only make this choice once, and be aware that these trees are quite tall and will appear through house floors so they are best on roofs or on deck areas. Actual sizes are shown.</BASEFONT></BODY>", (bool)false, (bool)false);
                AddButton(144, 39, 4023, 4023, 1, GumpButtonType.Reply, 0);
                AddButton(402, 39, 4023, 4023, 2, GumpButtonType.Reply, 0);
                AddButton(696, 39, 4023, 4023, 3, GumpButtonType.Reply, 0);
                AddButton(743, 414, 4023, 4023, 4, GumpButtonType.Reply, 0);
                AddButton(462, 414, 4023, 4023, 5, GumpButtonType.Reply, 0);
