        ...
        public NewFish() : base(0x09CC)
        {
                ...
                switch (Utility.Random(11))
                {
                    ...
                    case 10:
                        switch (Utility.Random(2))
                        {
                            ...
                            case 1: ResourceMods.SetRandomResource(false, false, this, CraftResource.AmethystBlock, true, null); break;
                        }
                        Hue = CraftResources.GetHue(Resource);
                        switch (Utility.Random(2))
                        {
                            case 0: Name = CraftResources.GetName(Resource) + " " + sName; break;
                            case 1: Name = CraftResources.GetName(Resource) + " " + sType + " " + sName; break;
                        }
                        break;
                }
            }
            else if (Utility.Random(10) == 1)
            {
                switch (Utility.Random(6))
                {
                    ...
                    case 6:
                        Name = "jade " + sType + " " + sName;
                        Hue = Utility.RandomList(0xB83, 0xB93, 0xB94, 0xB95, 0xB96);
                        break;
                    case 7:
                        Name = "fire " + sType + " " + sName;
                        Hue = Utility.RandomList(0x4E7, 0x4E8, 0x4E9, 0x4EA, 0x4EB, 0x4EC);
                        break;
                    case 8:
                        Name = "coldwater " + sType + " " + sName;
                        Hue = Utility.RandomList(0x551, 0x552, 0x553, 0x554, 0x555, 0x556);
                        break;
                    case 9:
                        Name = "poisonous " + sType + " " + sName;
                        Hue = Utility.RandomList(0x557, 0x558, 0x559, 0x55A, 0x55B, 0x55C);
                        break;
                    case 10:
                        switch (Utility.Random(2))
