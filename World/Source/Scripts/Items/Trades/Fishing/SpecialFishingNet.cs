...
namespace Server.Items
{
    public class SpecialFishingNet : Item
    {
        ...
        public override void AddNameProperties(ObjectPropertyList list)
        {
            ...
            list.Add(1049644, "Requires 60 Seafaring");
        }
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            else if (from.Skills[SkillName.Seafaring].Value < 60.0)
            {
        ...
        protected virtual void FinishEffect(Point3D p, Map map, Mobile from)
        {
            ...
            switch (Utility.Random(18))
            {
                ...
                case 17: monster = "Jellyfish"; break;
            }
            ...
            for (int i = 0; map != null && i < count; ++i)
            {
                ...
                else if (monster == "Jellyfish") { spawn = new Jellyfish(); }
            ...
            Server.Engines.Harvest.Fishing.SailorSkill(from, 6);
