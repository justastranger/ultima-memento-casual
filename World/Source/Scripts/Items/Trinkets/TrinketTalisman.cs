    ...
    public class TrinketTalisman : BaseTrinket
    {
        ...
        public TrinketTalisman() : base(0x2F58)
        {
            ...
            switch (trinket)
            {
                ...
                case 42:
                    Name = "gems"; Hue = 0xABE; ItemID = 0x4D0E;                // Rabbit's Foot
                    switch (Utility.RandomMinMax(0, 1))
                    {
                ...
                case 44:
                    Name = "chains"; ItemID = 0x4D10;               // Rabbit's Foot
                    switch (Utility.RandomMinMax(0, 1))
                    {
                ...
                case 45:
                    Name = "map"; ItemID = 0x4D11;              // Rabbit's Foot
                    switch (Utility.RandomMinMax(0, 1))
                    {
