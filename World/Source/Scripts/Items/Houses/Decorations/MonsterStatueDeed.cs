        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            else
            {
                switch (Utility.Random(35))
                {
                    ...
                    case 25: from.AddToBackpack(new MonsterStatuette(MonsterStatuetteType.Slime)); break;
                    case 26: from.AddToBackpack(new MonsterStatuette(MonsterStatuetteType.PlagueBeast)); break;
                    case 27: from.AddToBackpack(new MonsterStatuette(MonsterStatuetteType.RedDeath)); break;
                    case 28: from.AddToBackpack(new MonsterStatuette(MonsterStatuetteType.Spider)); break;
                    case 29: from.AddToBackpack(new MonsterStatuette(MonsterStatuetteType.OphidianArchMage)); break;
                    case 30: from.AddToBackpack(new MonsterStatuette(MonsterStatuetteType.OphidianWarrior)); break;
                    case 31: from.AddToBackpack(new MonsterStatuette(MonsterStatuetteType.OphidianKnight)); break;
                    case 32: from.AddToBackpack(new MonsterStatuette(MonsterStatuetteType.OphidianMage)); break;
                    case 33: from.AddToBackpack(new MonsterStatuette(MonsterStatuetteType.DreadHorn)); break;
                    case 34: from.AddToBackpack(new MonsterStatuette(MonsterStatuetteType.Minotaur)); break;
                }
