...
namespace Server.Items
{
    ...
    public class StoneWellDeed : BaseAddonDeed
    {
        ...
        public override void AddNameProperties(ObjectPropertyList list)
        {
            ...
            list.Add(1049644, "Stone Well");
        }

        public StoneWellDeed(Serial serial) : base(serial)
        {
        }
