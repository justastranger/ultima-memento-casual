...
{
    public class MyCircusTentSouthAddon : BaseAddon
    {
        ...
        public override BaseAddonDeed Deed
        {
            get
            {
                return new MyCircusTentSouthAddonDeed(Tent_Color1, Tent_Color2, 1);
            }
        }

        [Constructable]
        public MyCircusTentSouthAddon() : this(0, 0)
        {
        }

        [Constructable]
        public MyCircusTentSouthAddon(int RelHue1, int RelHue2)
        {
            ...
            AddComplexComponent((BaseAddon)this, 874, 4, 0, 0, RelHue2, -1, "tent", 1);
            AddComplexComponent((BaseAddon)this, 874, 4, 1, 0, RelHue1, -1, "tent", 1);
            AddComplexComponent((BaseAddon)this, 874, 4, 2, 0, RelHue2, -1, "tent", 1);
        ...
        public MyCircusTentSouthAddon(Serial serial) : base(serial)
        {
        }
    ...
    public class MyCircusTentSouthAddonDeed : BaseAddonDeed
    {
        public int TentColor1;
        public int TentColor2;
        ...
        public override BaseAddon Addon
        {
            get
            {
                return new MyCircusTentSouthAddon(Tent_Color1, Tent_Color2);
            }
        }

        [Constructable]
        public MyCircusTentSouthAddonDeed() : this(0, 0, 0)
        {
        }

        [Constructable]
        public MyCircusTentSouthAddonDeed(int RelHue1, int RelHue2, int RelRolled)
        {
            Weight = 50;
            ItemID = 0xA59;
            ...
            else
            {
                ...
                TentColor1 = Hue;
                TentColor2 = Utility.RandomColor(0);
            }

            Name = "Circus Tent (South Door)";
            TentFound = 1;
        }

        public class MyCircusTentMenu : ContextMenuEntry
        {
            private MyCircusTentSouthAddonDeed i_Tent;
            private Mobile m_From;

            public MyCircusTentMenu(Mobile from, MyCircusTentSouthAddonDeed tent) : base(5109, 1)
            {
                m_From = from;
                i_Tent = tent;
            }
        ...
        public MyCircusTentSouthAddonDeed(Serial serial) : base(serial)
        {
        }
