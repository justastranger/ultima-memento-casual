            ...
            for (int i = 0; i < GiftAttributes.m_Attributes.Length; ++i)
            {
                if (GiftAttributes.m_Attributes[i].m_Category == cat)
                {
                    ...
                    if (m_Item is BaseWeapon)
                        ...
                        attrvalue = ((BaseTrinket)m_Item).Attributes[GiftAttributes.m_Attributes[i].m_Attribute];
                ...
                if (cat == GiftAttributeCategory.Resists)
                {
                    for (int i = 0; i < GiftAttributes.m_ElementAttributes.Length; ++i)
                    {
                        ...
                        if (m_Item is BaseTrinket)
                            attrvalue = ((BaseTrinket)m_Item).Resistances[GiftAttributes.m_ElementAttributes[i].m_Attribute];
                        else
                ...
                case 2: // Attribute selected
                    {
                        ...
                        if ((levitem.Points - cost) >= 0)
                        {
                            ...
                            if (index >= 0 && index < GiftAttributes.m_Attributes.Length)
                            {
                                ...
                                {
                                    attrvalue = ((BaseTrinket)m_Item).Attributes[GiftAttributes.m_Attributes[index].m_Attribute];
                                    if (attrvalue < GiftAttributes.m_Attributes[index].m_MaxValue)
                                    {
                                        ((BaseTrinket)m_Item).Attributes[GiftAttributes.m_Attributes[index].m_Attribute] += 1;
                                        levitem.Points -= cost;
                                    }
                                }
                                else if (m_Item is BaseClothing)
                ...
                case 3: // WeaponAttribute selected
                    {
                        ...
                        if ((levitem.Points - cost) >= 0)
                        {
                            ...
                            if (index >= 0 && m_Item is BaseWeapon && index < GiftAttributes.m_WeaponAttributes.Length)
                            {
                ...
                case 4: // Armor Attributes Selected
                    {
                        ...
                        {
                            //add point to selected weapon attribute
                            if (index >= 0 && m_Item is BaseArmor && index < GiftAttributes.m_ArmorAttributes.Length)
                            {
                ...
                case 5: // Armor Resists Selected
                    {
                        ...
                        {
                            //add point to selected weapon attribute
                            if (index >= 0 && m_Item is BaseArmor && index < GiftAttributes.m_ResistanceTypes.Length)
                            {
                ...
                case 6: // Jewelry & Clothing Resists Selected
                    {
                        ...
                        {
                            //add point to selected weapon attribute
                            if (index >= 0 && (m_Item is BaseTrinket || m_Item is BaseClothing) && index < GiftAttributes.m_ElementAttributes.Length)
                            {
                                if (m_Item is BaseTrinket)
                                {
                                    attrvalue = ((BaseTrinket)m_Item).Resistances[GiftAttributes.m_ElementAttributes[index].m_Attribute];
                                    if (attrvalue < GiftAttributes.m_ElementAttributes[index].m_MaxValue)
                                    {
                                        ((BaseTrinket)m_Item).Resistances[GiftAttributes.m_ElementAttributes[index].m_Attribute] += 1;
                                        levitem.Points -= cost;
                                    }
                                }
                                else
