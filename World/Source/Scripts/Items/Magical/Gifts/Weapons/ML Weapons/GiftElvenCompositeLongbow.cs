...
{
    public class GiftElvenCompositeLongbow : BaseGiftRanged
    {
        ...
        [Constructable]
        public GiftElvenCompositeLongbow() : base(0x2D1E)
        {
            Weight = 5.0;
        ...
        public GiftElvenCompositeLongbow(Serial serial) : base(serial)
        {
        }
