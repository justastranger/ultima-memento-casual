    ...
    public class ItemExperienceGump : Gump
    {
        ...
        public void CreateAttributeList(AttributeCategory cat)
        {
            ...
            for (int i = 0; i < LevelAttributes.m_Attributes.Length; ++i)
            {
                if (LevelAttributes.m_Attributes[i].m_Category == cat)
                {
                    ...
                    else if (m_Item is BaseTrinket)
                        attrvalue = ((BaseTrinket)m_Item).Attributes[LevelAttributes.m_Attributes[i].m_Attribute];
                    ...
                    if (LevelAttributes.m_Attributes[i].m_Attribute == AosAttribute.LowerManaCost && attrvalue > MyServerSettings.LowerMana())
                        attrvalue = MyServerSettings.LowerMana();
                    else if (LevelAttributes.m_Attributes[i].m_Attribute == AosAttribute.LowerRegCost && attrvalue > MyServerSettings.LowerReg())
                        attrvalue = MyServerSettings.LowerReg();
            ...
            else if (m_Item is BaseTrinket || m_Item is BaseClothing)
            {
                if (cat == AttributeCategory.Resists)
                {
                    for (int i = 0; i < LevelAttributes.m_ElementAttributes.Length; ++i)
                    {
                        ...
                        if (m_Item is BaseTrinket)
                            attrvalue = ((BaseTrinket)m_Item).Resistances[LevelAttributes.m_ElementAttributes[i].m_Attribute];
                        else
        ...
        public static int GetPointCost(Item m_Item, int xp)
        {
            ...
            if (LevelItems.DoubleArtifactCost)
            {
                ...
                {
                    if (((BaseTrinket)m_Item).ArtifactRarity > 0)
                        cost *= 2;
                }
                else
                {
                ...
                case 2: // Attribute selected
                    {
                        ...
                        if ((levitem.Points - cost) >= 0)
                        {
                            ...
                            if (index >= 0 && index < LevelAttributes.m_Attributes.Length)
                            {
                                ...
                                {
                                    attrvalue = ((BaseTrinket)m_Item).Attributes[LevelAttributes.m_Attributes[index].m_Attribute];
                                    if (attrvalue < LevelAttributes.m_Attributes[index].m_MaxValue)
                                    {
                                        ((BaseTrinket)m_Item).Attributes[LevelAttributes.m_Attributes[index].m_Attribute] += 1;
                                        levitem.Points -= cost;
                                    }
                                }
                                else if (m_Item is BaseClothing)
                ...
                case 3: // WeaponAttribute selected
                    {
                        ...
                        if ((levitem.Points - cost) >= 0)
                        {
                            ...
                            if (index >= 0 && m_Item is BaseWeapon && index < LevelAttributes.m_WeaponAttributes.Length)
                            {
                ...
                case 4: // Armor Attributes Selected
                    {
                        ...
                        if ((levitem.Points - cost) >= 0)
                        {
                            //add point to selected armor attribute

                            if (index >= 0 && m_Item is BaseArmor && index < LevelAttributes.m_ArmorAttributes.Length)
                            {
                ...
                case 5: // Armor Resists Selected
                    {
                        ...
                        {
                            //add point to selected weapon attribute
                            if (index >= 0 && m_Item is BaseArmor && index < LevelAttributes.m_ResistanceTypes.Length)
                            {
                ...
                case 6: // Jewelry & Clothing Resists Selected
                    {
                        ...
                        {
                            //add point to selected weapon attribute
                            if (index >= 0 && (m_Item is BaseTrinket || m_Item is BaseClothing) && index < LevelAttributes.m_ElementAttributes.Length)
                            {
                                if (m_Item is BaseTrinket)
                                {
                                    attrvalue = ((BaseTrinket)m_Item).Resistances[LevelAttributes.m_ElementAttributes[index].m_Attribute];
                                    if (attrvalue < LevelAttributes.m_ElementAttributes[index].m_MaxValue)
                                    {
                                        ((BaseTrinket)m_Item).Resistances[LevelAttributes.m_ElementAttributes[index].m_Attribute] += 1;
                                        levitem.Points -= cost;
                                    }
                                }
                                else
