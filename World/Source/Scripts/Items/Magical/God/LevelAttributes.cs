...
namespace Server.Items
{
    ...
    public class LevelAttributes
    {
        ...
        {
            new AttributeInfo( AosAttribute.RegenHits, "Regen Hits", AttributeCategory.Stats, 5, 5 ),
            new AttributeInfo( AosAttribute.RegenStam, "Regen Stamina", AttributeCategory.Stats, 5, 5 ),
            new AttributeInfo( AosAttribute.RegenMana, "Regen Mana", AttributeCategory.Stats, 5, 5 ),
            ...
            new AttributeInfo( AosAttribute.BonusStr, "Bonus Strength", AttributeCategory.Stats, 10, 10 ),
            new AttributeInfo( AosAttribute.BonusDex, "Bonus Dex", AttributeCategory.Stats, 10, 10 ),
            new AttributeInfo( AosAttribute.BonusInt, "Bonus Int", AttributeCategory.Stats, 10, 10 ),
            new AttributeInfo( AosAttribute.BonusHits, "Bonus Hits", AttributeCategory.Stats, 5, 20 ),
            new AttributeInfo( AosAttribute.BonusStam, "Bonus Stamina", AttributeCategory.Stats, 5, 20 ),
            new AttributeInfo( AosAttribute.BonusMana, "Bonus Mana", AttributeCategory.Stats, 5, 20 ),
            ...
            new AttributeInfo( AosAttribute.SpellDamage, "Spell Damage", AttributeCategory.Magic, 4, 25 ),
            ...
            new AttributeInfo( AosAttribute.LowerManaCost, "Lower Mana Cost", AttributeCategory.Magic, 5, MyServerSettings.LowMana() ),
            new AttributeInfo( AosAttribute.LowerRegCost, "Lower Reagent Cost", AttributeCategory.Magic, 5, MyServerSettings.LowReg() ),
            new AttributeInfo( AosAttribute.ReflectPhysical, "Reflect Physical Damage", AttributeCategory.Melee, 2, 50 ),
            new AttributeInfo( AosAttribute.EnhancePotions, "Enhance Potions", AttributeCategory.Magic, 2, 25 ),
            new AttributeInfo( AosAttribute.Luck, "Luck", AttributeCategory.Misc, 2, 500 ),
    ...
    public class AttributeInfo
    {
        ...
        public AttributeInfo(AosAttribute attribute, string name, AttributeCategory category, int xp, int maxvalue)
        {
            ...
            if (attribute == AosAttribute.LowerManaCost && MyServerSettings.LowerMana() < 1)
                run = false;

            if (attribute == AosAttribute.LowerRegCost && MyServerSettings.LowerReg() < 1)
                run = false;
