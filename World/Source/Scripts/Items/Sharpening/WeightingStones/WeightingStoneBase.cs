...
{
    public abstract class WeightingStoneBase : Item
    {
        ...
        public WeightingStoneBase(int uses, int maxDamageBonus, double requiredBlacksmithSkillLevel) : base(0x1F14)
        {
            Weight = 1.0;
            Hue = 0x38C;
            Uses = uses;
        ...
        public WeightingStoneBase(Serial serial) : base(serial)
        {
        }
        ...
        {
            private WeightingStoneBase _stone;

            public InternalTarget(WeightingStoneBase stone) : base(18, false, TargetFlags.None)
            {
                _stone = stone;
            }
