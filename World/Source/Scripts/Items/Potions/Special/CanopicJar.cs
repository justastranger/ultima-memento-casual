    ...
    public class CanopicJar : Item
    {
        ...
        public CanopicJar() : base(0x2FEE)
        {
            ...
            if (Weight < 30.0)
            {
                ...
                ColorText3 = "Can Make A Keg Of " + JarPotion + "";
                ColorHue3 = "FDC844";
            }
        }
            ...
            else
            {
                ...
                else
                {
                    if (pack.ConsumeTotal(typeof(Gold), 500))
                    {
                        ...
                        jar.ColorText1 = ColorText1;
                        jar.ColorHue1 = "0080FF";
                        jar.ColorText2 = "belonged to " + JarOwner;
                        jar.ColorHue2 = "4AADFE";
                        jar.ColorText3 = "Worth " + CoinPrice + " Gold";
                        jar.ColorHue3 = "FDC844";
