...
namespace Server.Items
{
    ...
    public class ElixirAnimalLore : BaseElixir
    {
        ...
        public override void Drink(Mobile m)
        {
            ...
            {
                SkillName skill = SkillName.Druidism;
                int level = 0;
    ...
    public class ElixirAnimalTaming : BaseElixir
    {
        ...
        public override void Drink(Mobile m)
        {
            ...
            {
                SkillName skill = SkillName.Taming;
                int level = 0;
    ...
    public class ElixirArchery : BaseElixir
    {
        ...
        public override void Drink(Mobile m)
        {
            ...
            {
                SkillName skill = SkillName.Marksmanship;
                int level = 1;
    ...
    public class ElixirDetectHidden : BaseElixir
    {
        ...
        public override void Drink(Mobile m)
        {
            ...
            {
                SkillName skill = SkillName.Searching;
                int level = 0;
    ...
    public class ElixirEvalInt : BaseElixir
    {
        ...
        public override void Drink(Mobile m)
        {
            ...
            {
                SkillName skill = SkillName.Psychology;
                int level = 1;
    ...
    public class ElixirFishing : BaseElixir
    {
        ...
        public override void Drink(Mobile m)
        {
            ...
            {
                SkillName skill = SkillName.Seafaring;
                int level = 1;
    ...
    public class ElixirFletching : BaseElixir
    {
        ...
        public override void Drink(Mobile m)
        {
            ...
            {
                SkillName skill = SkillName.Bowcraft;
                int level = 0;
    ...
    public class ElixirMacing : BaseElixir
    {
        ...
        public override void Drink(Mobile m)
        {
            ...
            {
                SkillName skill = SkillName.Bludgeoning;
                int level = 1;
    ...
    public class ElixirSpiritSpeak : BaseElixir
    {
        ...
        public override void Drink(Mobile m)
        {
            ...
            {
                SkillName skill = SkillName.Spiritualism;
                int level = 1;
    ...
    public class ElixirTasteID : BaseElixir
    {
        ...
        public override void Drink(Mobile m)
        {
            ...
            {
                SkillName skill = SkillName.Tasting;
                int level = 0;
    ...
    public class ElixirWrestling : BaseElixir
    {
        ...
        public override void Drink(Mobile m)
        {
            ...
            {
                SkillName skill = SkillName.FistFighting;
                int level = 1;
