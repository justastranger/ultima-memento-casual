...
namespace Server.Items
{
    ...
    public class PumpkinLarge : Food
    {
        ...
        [Constructable]
        public PumpkinLarge(int amount) : base(amount, 0x54DE)
        {
            Name = "large pumpkin";
            this.Weight = 10.0;
            this.FillFactor = 10;
    ...
    public class PumpkinTall : Food
    {
        ...
        [Constructable]
        public PumpkinTall(int amount) : base(amount, 0x5498)
        {
            Name = "tall pumpkin";
            this.Weight = 10.0;
            this.FillFactor = 10;
    ...
    public class PumpkinGreen : Food
    {
        ...
        [Constructable]
        public PumpkinGreen(int amount) : base(amount, 0x54E0)
        {
            Name = "green pumpkin";
            this.Weight = 10.0;
            this.FillFactor = 10;
    ...
    public class PumpkinGiant : Food
    {
        ...
        [Constructable]
        public PumpkinGiant(int amount) : base(amount, 0x54DF)
        {
            Name = "giant pumpkin";
            this.Weight = 100.0;
            this.FillFactor = 20;
