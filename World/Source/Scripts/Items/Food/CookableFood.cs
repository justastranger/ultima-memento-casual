...
namespace Server.Items
{
    public abstract class CookableFood : Item
    {
        ...
        public static bool IsHeatSource(object targeted)
        {
            ...
            else if (itemID == 0xFAC || itemID == 0x576A || itemID == 0x576B || itemID == 0x576C || itemID == 0x576D || itemID == 0x576E || itemID == 0x5771 || itemID == 0x5772 || itemID == 0x5773 || itemID == 0x5774 || itemID == 0x5775)
                return true; // Firepit
    ...
    public class RawPig : CookableFood
    {
        ...
        [Constructable]
        public RawPig(int amount) : base(0x9D3, 10)
        {
            Name = "raw pig";
            Weight = 1.0;
            Stackable = true;
