...
namespace Server.Regions
{
    public class SafeRegion : BaseRegion
    {
        ...
        {
            if (this.Name == "the Fort of Tenebrae")
            {
                global = LightCycle.DungeonLevel;
            }
            else if (this.Name == "the Furnace Vorpal Dock" || this.Name == "the Kraken Eye Cave" || this.Name == "the Anchored Cave" || this.Name == "the Ravendark Tomb" || this.Name == "the Furnace Eye Cave")
            {
