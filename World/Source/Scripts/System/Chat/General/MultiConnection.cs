    ...
    public class MultiConnection
    {
        ...
        private void BeginReceive()
        {
            try
            {
                ...
                byte[] msg = System.Text.Encoding.ASCII.GetBytes("    " + MySettings.S_ServerName);
        ...
        public void SendMessage(Mobile m, string str)
        {
            ...
            {
                byte[] msg = System.Text.Encoding.ASCII.GetBytes("    <" + MySettings.S_ServerName + "> " + m.RawName + ": " + str);
