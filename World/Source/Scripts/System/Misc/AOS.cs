...
namespace Server
{
    ...
    public sealed class AosAttributes : BaseAttributes
    {
        ...
        public static int GetValue(Mobile m, AosAttribute attribute)
        {
            ...
            if (attribute == AosAttribute.LowerRegCost && value > MyServerSettings.LowerReg())
                ...
                value = MyServerSettings.LowerMana();
    ...
    public sealed class AosSkillBonuses : BaseAttributes
    {
        ...
        public void GetProperties(ObjectPropertyList list)
        {
            ...
            GetValues(0, out skill0, out bonus0);
            GetValues(1, out skill1, out bonus1);
            GetValues(2, out skill2, out bonus2);
            GetValues(3, out skill3, out bonus3);
            GetValues(4, out skill4, out bonus4);
            ...
            if (bonus0 > 0)
                list.Add(1060451 + 0, "#{0}\t{1}", 1044060 + (int)skill0, bonus0);
            if (bonus1 > 0)
                list.Add(1060451 + 1, "#{0}\t{1}", 1044060 + (int)skill1, bonus1);
            if (bonus2 > 0)
                list.Add(1060451 + 2, "#{0}\t{1}", 1044060 + (int)skill2, bonus2);
            if (bonus3 > 0)
                list.Add(1060451 + 3, "#{0}\t{1}", 1044060 + (int)skill3, bonus3);
            if (bonus4 > 0)
        ...
        public void CheckCancelMorph(Mobile m)
        {
            ...
            if (!m.CanBeginAction(typeof(Deception)) && m.Skills[SkillName.Ninjitsu].Value < 30.0)
            {
                if (m is PlayerMobile)
                    ((PlayerMobile)m).SetHairMods(-1, -1);
                m.BodyMod = 0;
