...
namespace Server.Misc
{
	public class ClientVerification
	{
		...
		private static void SendAnnoyGump( Mobile m )
		{
			...
			{
				Gump g = new WarningGump( 1060637, 30720, String.Format( "Your client is out of date. Please update your client.<br>This server recommends that your client version be at least {0}.<br> <br>You are currently using version {1}.<br> <br>To patch, run UOPatch.exe inside your client folder.", Required, m.NetState.Version ), 0xFFC000, 480, 360,
