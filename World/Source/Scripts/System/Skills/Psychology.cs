...
namespace Server.SkillHandlers
{
    public class Psychology
    {
        ...
        {
            m.Target = new Psychology.InternalTarget();
        ...
        private class InternalTarget : Target
        {
            ...
            protected override void OnTarget(Mobile from, object targeted)
            {
                ...
                else if (targeted is Mobile)
                {
                    ...
                    int marginOfError = Math.Max(0, 20 - (int)(from.Skills[SkillName.Psychology].Value / 5));
                    ...
                    if (from.CheckTargetSkill(SkillName.Psychology, targ, 0.0, 125.0))
                    {
                        ...
                        if (from.Skills[SkillName.Psychology].Base >= 76.0)
