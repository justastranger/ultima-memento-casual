...
namespace Server.Items
{
    public class GetTrueBestSkill
    {
        ...
        {
            List<LGSkillLists> skilllist = new List<LGSkillLists>();
            skilllist.Add(new LGSkillLists(SkillName.Mercantile, from.Skills.Mercantile.Value));
            skilllist.Add(new LGSkillLists(SkillName.Blacksmith, from.Skills.Blacksmith.Value));
            skilllist.Add(new LGSkillLists(SkillName.Bowcraft, from.Skills.Bowcraft.Value));
            ...
            skilllist.Add(new LGSkillLists(SkillName.Seafaring, from.Skills.Seafaring.Value));
            skilllist.Sort(delegate (LGSkillLists p1, LGSkillLists p2) { return p2.LGSkillVal.CompareTo(p1.LGSkillVal); });
            skill1 = skilllist[0].LGSkill;
            skill2 = skilllist[1].LGSkill;
            skill3 = skilllist[2].LGSkill;
        ...
        public static void GetSkillFITop5(Mobile from, ref SkillName skill1, ref SkillName skill2, ref SkillName skill3, ref SkillName skill4, ref SkillName skill5)
        {
            ...
            skilllist.Add(new LGSkillLists(SkillName.Marksmanship, from.Skills.Marksmanship.Value));
            skilllist.Add(new LGSkillLists(SkillName.Swords, from.Skills.Swords.Value));
            skilllist.Add(new LGSkillLists(SkillName.Bludgeoning, from.Skills.Bludgeoning.Value));
            skilllist.Add(new LGSkillLists(SkillName.Fencing, from.Skills.Fencing.Value));
            skilllist.Add(new LGSkillLists(SkillName.Lumberjacking, from.Skills.Lumberjacking.Value));
            skilllist.Add(new LGSkillLists(SkillName.FistFighting, from.Skills.FistFighting.Value));
            skilllist.Add(new LGSkillLists(SkillName.Knightship, from.Skills.Knightship.Value));
    ...
    public class ManaRedux
    {
        ...
        {
            int mana = BaseMana;
            double skillTotal = GetReduxSkill(from, SkillName.Swords) + GetReduxSkill(from, SkillName.Bludgeoning)
                + GetReduxSkill(from, SkillName.Fencing) + GetReduxSkill(from, SkillName.Marksmanship) + GetReduxSkill(from, SkillName.Parry)
