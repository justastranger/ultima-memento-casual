        ...
        public static void MyHelpAdmin_OnCommand(CommandEventArgs e)
        {
            ...
            if (!from.HasGump(typeof(SpeechGump)))
            {
                string sText = ""
                    ...
                    + "There is a logging system built into the game that tracks where a player goes, what they kill, when they die, what traps they spring, and some other minor activities. They can turn this option off for more privacy. The town criers will use these logs to shout out various things that the players are doing in the game. One can talk to a town crier and learn about all the events. The logs are kept in the Saves folder.<br><br>"
                    ...
                    + "[viewhouses - Lets you see a list of houses owned by the one you target.<br><br>"
                ...
                from.SendGump(new SpeechGump(from, "ADMINISTRATIVE HELP", sText));
            }
        }
    }
}