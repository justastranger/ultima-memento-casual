...
namespace Server.Gumps
{
    public class SkillListingGump : Gump
    {
        ...
        {
            int SkillDisplay = ((PlayerMobile)from).SkillDisplay;
            ...
            fromSkill = from.Skills[SkillName.Druidism]; if (fromSkill.Lock == SkillLock.Up || (fromSkill.Lock == SkillLock.Locked && SkillDisplay > 0)) { r++; }
            fromSkill = from.Skills[SkillName.Taming]; if (fromSkill.Lock == SkillLock.Up || (fromSkill.Lock == SkillLock.Locked && SkillDisplay > 0)) { r++; }
            fromSkill = from.Skills[SkillName.Marksmanship]; if (fromSkill.Lock == SkillLock.Up || (fromSkill.Lock == SkillLock.Locked && SkillDisplay > 0)) { r++; }
            ...
            fromSkill = from.Skills[SkillName.Knightship]; if (fromSkill.Lock == SkillLock.Up || (fromSkill.Lock == SkillLock.Locked && SkillDisplay > 0)) { r++; }
            fromSkill = from.Skills[SkillName.Cooking]; if (fromSkill.Lock == SkillLock.Up || (fromSkill.Lock == SkillLock.Locked && SkillDisplay > 0)) { r++; }
            fromSkill = from.Skills[SkillName.Searching]; if (fromSkill.Lock == SkillLock.Up || (fromSkill.Lock == SkillLock.Locked && SkillDisplay > 0)) { r++; }
            ...
            fromSkill = from.Skills[SkillName.Elementalism]; if (fromSkill.Lock == SkillLock.Up || (fromSkill.Lock == SkillLock.Locked && SkillDisplay > 0)) { r++; }
            fromSkill = from.Skills[SkillName.Psychology]; if (fromSkill.Lock == SkillLock.Up || (fromSkill.Lock == SkillLock.Locked && SkillDisplay > 0)) { r++; }
            fromSkill = from.Skills[SkillName.Fencing]; if (fromSkill.Lock == SkillLock.Up || (fromSkill.Lock == SkillLock.Locked && SkillDisplay > 0)) { r++; }
            fromSkill = from.Skills[SkillName.Seafaring]; if (fromSkill.Lock == SkillLock.Up || (fromSkill.Lock == SkillLock.Locked && SkillDisplay > 0)) { r++; }
            fromSkill = from.Skills[SkillName.Bowcraft]; if (fromSkill.Lock == SkillLock.Up || (fromSkill.Lock == SkillLock.Locked && SkillDisplay > 0)) { r++; }
            ...
            fromSkill = from.Skills[SkillName.Mercantile]; if (fromSkill.Lock == SkillLock.Up || (fromSkill.Lock == SkillLock.Locked && SkillDisplay > 0)) { r++; }
            ...
            fromSkill = from.Skills[SkillName.Bludgeoning]; if (fromSkill.Lock == SkillLock.Up || (fromSkill.Lock == SkillLock.Locked && SkillDisplay > 0)) { r++; }
            ...
            fromSkill = from.Skills[SkillName.Spiritualism]; if (fromSkill.Lock == SkillLock.Up || (fromSkill.Lock == SkillLock.Locked && SkillDisplay > 0)) { r++; }
            ...
            fromSkill = from.Skills[SkillName.Tasting]; if (fromSkill.Lock == SkillLock.Up || (fromSkill.Lock == SkillLock.Locked && SkillDisplay > 0)) { r++; }
            ...
            fromSkill = from.Skills[SkillName.FistFighting]; if (fromSkill.Lock == SkillLock.Up || (fromSkill.Lock == SkillLock.Locked && SkillDisplay > 0)) { r++; }
            ...
            fromSkill = from.Skills[SkillName.Bludgeoning]; if (fromSkill.Lock == SkillLock.Up || (fromSkill.Lock == SkillLock.Locked && SkillDisplay > 0)) { if (fromSkill.Lock == SkillLock.Locked) { color = 0x31; } AddLabel(8, y, color, @"Bludgeoning"); AddLabel(140, y, color, @"" + fromSkill.Base + ""); AddLabel(198, y, color, @"" + fromSkill.Value + ""); color = 1153; y = y + 24; }
            fromSkill = from.Skills[SkillName.Bowcraft]; if (fromSkill.Lock == SkillLock.Up || (fromSkill.Lock == SkillLock.Locked && SkillDisplay > 0)) { if (fromSkill.Lock == SkillLock.Locked) { color = 0x31; } AddLabel(8, y, color, @"Bowcrafting"); AddLabel(140, y, color, @"" + fromSkill.Base + ""); AddLabel(198, y, color, @"" + fromSkill.Value + ""); color = 1153; y = y + 24; }
            ...
            fromSkill = from.Skills[SkillName.Druidism]; if (fromSkill.Lock == SkillLock.Up || (fromSkill.Lock == SkillLock.Locked && SkillDisplay > 0)) { if (fromSkill.Lock == SkillLock.Locked) { color = 0x31; } AddLabel(8, y, color, @"Druidism"); AddLabel(140, y, color, @"" + fromSkill.Base + ""); AddLabel(198, y, color, @"" + fromSkill.Value + ""); color = 1153; y = y + 24; }
            fromSkill = from.Skills[SkillName.Elementalism]; if (fromSkill.Lock == SkillLock.Up || (fromSkill.Lock == SkillLock.Locked && SkillDisplay > 0)) { if (fromSkill.Lock == SkillLock.Locked) { color = 0x31; } AddLabel(8, y, color, @"Elementalism"); AddLabel(140, y, color, @"" + fromSkill.Base + ""); AddLabel(198, y, color, @"" + fromSkill.Value + ""); color = 1153; y = y + 24; }
            ...
            fromSkill = from.Skills[SkillName.FistFighting]; if (fromSkill.Lock == SkillLock.Up || (fromSkill.Lock == SkillLock.Locked && SkillDisplay > 0)) { if (fromSkill.Lock == SkillLock.Locked) { color = 0x31; } AddLabel(8, y, color, @"Fist Fighting"); AddLabel(140, y, color, @"" + fromSkill.Base + ""); AddLabel(198, y, color, @"" + fromSkill.Value + ""); color = 1153; y = y + 24; }
            ...
            fromSkill = from.Skills[SkillName.Knightship]; if (fromSkill.Lock == SkillLock.Up || (fromSkill.Lock == SkillLock.Locked && SkillDisplay > 0)) { if (fromSkill.Lock == SkillLock.Locked) { color = 0x31; } AddLabel(8, y, color, @"Knightship"); AddLabel(140, y, color, @"" + fromSkill.Base + ""); AddLabel(198, y, color, @"" + fromSkill.Value + ""); color = 1153; y = y + 24; }
            ...
            fromSkill = from.Skills[SkillName.Marksmanship]; if (fromSkill.Lock == SkillLock.Up || (fromSkill.Lock == SkillLock.Locked && SkillDisplay > 0)) { if (fromSkill.Lock == SkillLock.Locked) { color = 0x31; } AddLabel(8, y, color, @"Marksmanship"); AddLabel(140, y, color, @"" + fromSkill.Base + ""); AddLabel(198, y, color, @"" + fromSkill.Value + ""); color = 1153; y = y + 24; }
            ...
            fromSkill = from.Skills[SkillName.Mercantile]; if (fromSkill.Lock == SkillLock.Up || (fromSkill.Lock == SkillLock.Locked && SkillDisplay > 0)) { if (fromSkill.Lock == SkillLock.Locked) { color = 0x31; } AddLabel(8, y, color, @"Mercantile"); AddLabel(140, y, color, @"" + fromSkill.Base + ""); AddLabel(198, y, color, @"" + fromSkill.Value + ""); color = 1153; y = y + 24; }
            ...
            fromSkill = from.Skills[SkillName.Psychology]; if (fromSkill.Lock == SkillLock.Up || (fromSkill.Lock == SkillLock.Locked && SkillDisplay > 0)) { if (fromSkill.Lock == SkillLock.Locked) { color = 0x31; } AddLabel(8, y, color, @"Psychology"); AddLabel(140, y, color, @"" + fromSkill.Base + ""); AddLabel(198, y, color, @"" + fromSkill.Value + ""); color = 1153; y = y + 24; }
            ...
            fromSkill = from.Skills[SkillName.Seafaring]; if (fromSkill.Lock == SkillLock.Up || (fromSkill.Lock == SkillLock.Locked && SkillDisplay > 0)) { if (fromSkill.Lock == SkillLock.Locked) { color = 0x31; } AddLabel(8, y, color, @"Seafaring"); AddLabel(140, y, color, @"" + fromSkill.Base + ""); AddLabel(198, y, color, @"" + fromSkill.Value + ""); color = 1153; y = y + 24; }
            fromSkill = from.Skills[SkillName.Searching]; if (fromSkill.Lock == SkillLock.Up || (fromSkill.Lock == SkillLock.Locked && SkillDisplay > 0)) { if (fromSkill.Lock == SkillLock.Locked) { color = 0x31; } AddLabel(8, y, color, @"Searching"); AddLabel(140, y, color, @"" + fromSkill.Base + ""); AddLabel(198, y, color, @"" + fromSkill.Value + ""); color = 1153; y = y + 24; }
            ...
            fromSkill = from.Skills[SkillName.Spiritualism]; if (fromSkill.Lock == SkillLock.Up || (fromSkill.Lock == SkillLock.Locked && SkillDisplay > 0)) { if (fromSkill.Lock == SkillLock.Locked) { color = 0x31; } AddLabel(8, y, color, @"Spiritualism"); AddLabel(140, y, color, @"" + fromSkill.Base + ""); AddLabel(198, y, color, @"" + fromSkill.Value + ""); color = 1153; y = y + 24; }
            ...
            fromSkill = from.Skills[SkillName.Taming]; if (fromSkill.Lock == SkillLock.Up || (fromSkill.Lock == SkillLock.Locked && SkillDisplay > 0)) { if (fromSkill.Lock == SkillLock.Locked) { color = 0x31; } AddLabel(8, y, color, @"Taming"); AddLabel(140, y, color, @"" + fromSkill.Base + ""); AddLabel(198, y, color, @"" + fromSkill.Value + ""); color = 1153; y = y + 24; }
            fromSkill = from.Skills[SkillName.Tasting]; if (fromSkill.Lock == SkillLock.Up || (fromSkill.Lock == SkillLock.Locked && SkillDisplay > 0)) { if (fromSkill.Lock == SkillLock.Locked) { color = 0x31; } AddLabel(8, y, color, @"Tasting"); AddLabel(140, y, color, @"" + fromSkill.Base + ""); AddLabel(198, y, color, @"" + fromSkill.Value + ""); color = 1153; y = y + 24; }
